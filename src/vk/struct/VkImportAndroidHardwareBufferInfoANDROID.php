...
final class VkImportAndroidHardwareBufferInfoANDROID implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImportAndroidHardwareBufferInfoANDROID', false), $vulkan);
