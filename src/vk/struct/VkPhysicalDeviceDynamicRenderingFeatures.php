...
final class VkPhysicalDeviceDynamicRenderingFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceDynamicRenderingFeatures', false), $vulkan);
