...
final class VkLatencySleepInfoNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "signalSemaphore" => $this->getSignalSemaphore(),
          "value" => $this->getValue(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkLatencySleepInfoNV', false), $vulkan);
