...
final class VkRenderPassInputAttachmentAspectCreateInfo implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "aspectReferenceCount" => $this->getAspectReferenceCount(),
          "pAspectReferences" => $this->getPAspectReferences(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkRenderPassInputAttachmentAspectCreateInfo', false), $vulkan);
    ...
    public function getPAspectReferences(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkInputAttachmentAspectReference', $cValue, $ffi); /** PTRANS */
        return $phpValue;
    }
