...
final class VkPhysicalDeviceProvokingVertexPropertiesEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "provokingVertexModePerPipeline" => $this->getProvokingVertexModePerPipeline(),
          "transformFeedbackPreservesTriangleFanProvokingVertex" => $this->getTransformFeedbackPreservesTriangleFanProvokingVertex(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceProvokingVertexPropertiesEXT', false), $vulkan);
