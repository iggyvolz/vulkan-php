...
final class VkPhysicalDeviceDescriptorPoolOverallocationFeaturesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceDescriptorPoolOverallocationFeaturesNV', false), $vulkan->ffi);
