...
final class VkPhysicalDeviceShaderDrawParametersFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderDrawParametersFeatures', false), $vulkan);
