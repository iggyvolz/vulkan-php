...
final class VkCommandBufferInheritanceViewportScissorInfoNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCommandBufferInheritanceViewportScissorInfoNV', false), $vulkan->ffi);
