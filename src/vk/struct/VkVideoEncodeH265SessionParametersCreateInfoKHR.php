...
final class VkVideoEncodeH265SessionParametersCreateInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265SessionParametersCreateInfoKHR', false), $vulkan->ffi);
    ...
    public function getPParametersAddInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVideoEncodeH265SessionParametersAddInfoKHR', $cValue, $ffi);
        return $phpValue;
    }
