...
final class VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT', false), $vulkan->ffi);
