...
final class VkPhysicalDeviceExternalImageFormatInfo implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceExternalImageFormatInfo', false), $vulkan);
