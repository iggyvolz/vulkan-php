...
final class VkPipelineCoverageReductionStateCreateInfoNV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPipelineCoverageReductionStateCreateInfoNV', false), $vulkan);
