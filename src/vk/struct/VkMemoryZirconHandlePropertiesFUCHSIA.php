...
final class VkMemoryZirconHandlePropertiesFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkMemoryZirconHandlePropertiesFUCHSIA', false), $vulkan);
