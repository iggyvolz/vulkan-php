...
final class VkPhysicalDevicePerformanceQueryPropertiesKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "allowCommandBufferQueryCopies" => $this->getAllowCommandBufferQueryCopies(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePerformanceQueryPropertiesKHR', false), $vulkan);
