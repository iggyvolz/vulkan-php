...
final class VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures', false), $vulkan->ffi);
