...
final class VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures', false));
