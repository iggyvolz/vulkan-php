...
final class VkAccelerationStructureDeviceAddressInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkAccelerationStructureDeviceAddressInfoKHR', false), $vulkan);
