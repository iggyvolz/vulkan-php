...
final class VkPhysicalDeviceImageRobustnessFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceImageRobustnessFeatures', false), $vulkan);
