...
final class VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR', false), $vulkan->ffi);
