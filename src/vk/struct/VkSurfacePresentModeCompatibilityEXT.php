...
final class VkSurfacePresentModeCompatibilityEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSurfacePresentModeCompatibilityEXT', false), $vulkan);
