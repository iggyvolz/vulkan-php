...
final class VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT', false), $vulkan->ffi);
