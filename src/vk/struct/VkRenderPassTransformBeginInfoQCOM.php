...
final class VkRenderPassTransformBeginInfoQCOM implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkRenderPassTransformBeginInfoQCOM', false), $vulkan);
