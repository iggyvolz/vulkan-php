...
final class VkPhysicalDeviceProtectedMemoryProperties implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceProtectedMemoryProperties', false), $vulkan);
