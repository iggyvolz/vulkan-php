...
final class VkPhysicalDevicePipelineCreationCacheControlFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePipelineCreationCacheControlFeatures', false), $vulkan);
