...
final class VkPhysicalDevicePipelineCreationCacheControlFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePipelineCreationCacheControlFeatures', false), $vulkan->ffi);
