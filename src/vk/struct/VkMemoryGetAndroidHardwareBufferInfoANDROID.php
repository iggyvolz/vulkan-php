...
final class VkMemoryGetAndroidHardwareBufferInfoANDROID implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkMemoryGetAndroidHardwareBufferInfoANDROID', false), $vulkan);
