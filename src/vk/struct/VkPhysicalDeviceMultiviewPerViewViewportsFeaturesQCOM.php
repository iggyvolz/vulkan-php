...
final class VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMultiviewPerViewViewportsFeaturesQCOM', false), $vulkan->ffi);
