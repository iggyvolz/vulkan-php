...
final class VkResolveImageInfo2 implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkResolveImageInfo2', false), $vulkan);
    ...
    public function getPRegions(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkImageResolve2', $cValue, $ffi); /** PTRANS */
        return $phpValue;
    }
