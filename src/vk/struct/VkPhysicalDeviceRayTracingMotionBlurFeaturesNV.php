...
final class VkPhysicalDeviceRayTracingMotionBlurFeaturesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceRayTracingMotionBlurFeaturesNV', false), $vulkan->ffi);
