...
final class VkDescriptorSetLayoutHostMappingInfoVALVE implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "descriptorOffset" => $this->getDescriptorOffset(),
          "descriptorSize" => $this->getDescriptorSize(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDescriptorSetLayoutHostMappingInfoVALVE', false), $vulkan);
