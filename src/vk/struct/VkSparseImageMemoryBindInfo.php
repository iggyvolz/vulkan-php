...
final class VkSparseImageMemoryBindInfo
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSparseImageMemoryBindInfo', false), $vulkan->ffi);
    ...
    public function getPBinds(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkSparseImageMemoryBind', $cValue, $ffi);
        return $phpValue;
    }
