...
final class VkAndroidHardwareBufferFormatProperties2ANDROID implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkAndroidHardwareBufferFormatProperties2ANDROID', false), $vulkan);
