...
final class VkPhysicalDeviceCubicWeightsFeaturesQCOM implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "selectableCubicWeights" => $this->getSelectableCubicWeights(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceCubicWeightsFeaturesQCOM', false), $vulkan);
