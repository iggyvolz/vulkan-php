...
final class VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures', false), $vulkan->ffi);
