...
final class VkPhysicalDeviceCubicClampFeaturesQCOM implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "cubicRangeClamp" => $this->getCubicRangeClamp(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceCubicClampFeaturesQCOM', false), $vulkan);
