...
final class VkPhysicalDeviceShaderTerminateInvocationFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderTerminateInvocationFeatures', false), $vulkan->ffi);
