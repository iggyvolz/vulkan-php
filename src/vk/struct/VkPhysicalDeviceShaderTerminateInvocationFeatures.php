...
final class VkPhysicalDeviceShaderTerminateInvocationFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderTerminateInvocationFeatures', false), $vulkan);
