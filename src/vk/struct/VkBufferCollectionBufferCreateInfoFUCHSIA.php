...
final class VkBufferCollectionBufferCreateInfoFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkBufferCollectionBufferCreateInfoFUCHSIA', false), $vulkan);
