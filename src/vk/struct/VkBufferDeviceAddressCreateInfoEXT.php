...
final class VkBufferDeviceAddressCreateInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkBufferDeviceAddressCreateInfoEXT', false), $vulkan);
