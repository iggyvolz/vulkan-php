...
final class VkSwapchainImageCreateInfoANDROID implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSwapchainImageCreateInfoANDROID', false), $vulkan);
    ...
    public function getUsage(): array
    {
        ...
        $phpValue = \iggyvolz\vulkan\enum\VkSwapchainImageUsageFlagBitsANDROID::fromInt($cValue);
        return $phpValue;
    }
