...
final class VkVideoEncodeH264SessionParametersFeedbackInfoEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264SessionParametersFeedbackInfoEXT', false), $vulkan->ffi);
