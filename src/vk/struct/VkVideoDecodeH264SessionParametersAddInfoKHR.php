...
final class VkVideoDecodeH264SessionParametersAddInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoDecodeH264SessionParametersAddInfoKHR', false), $vulkan);
