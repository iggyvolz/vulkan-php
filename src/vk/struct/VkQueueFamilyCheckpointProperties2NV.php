...
final class VkQueueFamilyCheckpointProperties2NV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkQueueFamilyCheckpointProperties2NV', false), $vulkan);
