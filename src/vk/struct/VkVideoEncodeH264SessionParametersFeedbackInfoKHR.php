...
final class VkVideoEncodeH264SessionParametersFeedbackInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264SessionParametersFeedbackInfoKHR', false), $vulkan);
