...
final class VkVideoEncodeH264SessionParametersFeedbackInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264SessionParametersFeedbackInfoKHR', false), $vulkan->ffi);
