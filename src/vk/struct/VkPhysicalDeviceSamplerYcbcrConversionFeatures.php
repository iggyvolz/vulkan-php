...
final class VkPhysicalDeviceSamplerYcbcrConversionFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceSamplerYcbcrConversionFeatures', false), $vulkan);
