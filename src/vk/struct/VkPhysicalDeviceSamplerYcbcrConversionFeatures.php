...
final class VkPhysicalDeviceSamplerYcbcrConversionFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceSamplerYcbcrConversionFeatures', false), $vulkan->ffi);
