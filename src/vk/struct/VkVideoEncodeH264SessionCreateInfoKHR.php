...
final class VkVideoEncodeH264SessionCreateInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264SessionCreateInfoKHR', false), $vulkan);
