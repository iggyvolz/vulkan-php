...
final class VkCuLaunchInfoNVX implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCuLaunchInfoNVX', false), $vulkan);
     ...
     * VkCuFunctionNVX/
     */
    public function getFunction(): VkCuFunctionNVX
    {
        $ffi = $this->vulkan->ffi;
        $cValue = $this->cdata->function;
        $phpValue = new \iggyvolz\vulkan\struct\VkCuFunctionNVX($cValue, $ffi);
        return $phpValue;
    }

    public function setFunction(VkCuFunctionNVX $phpValue): void
    {
        $ffi = $this->vulkan->ffi;
        $cValue = $phpValue->cdata;
