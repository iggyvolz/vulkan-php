...
final class VkVideoEncodeH265SessionParametersAddInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265SessionParametersAddInfoKHR', false), $vulkan);
