...
final class VkVideoEncodeH265RateControlLayerInfoEXT
{
    /**
     * @internal
     */
    ...
    public static function create(
        ...
        null|VkVideoEncodeH265FrameSizeEXT $maxFrameSize = null,
    ): self
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265RateControlLayerInfoEXT', false), $vulkan->ffi);
     ...
     */
    public function getMaxFrameSize(): VkVideoEncodeH265FrameSizeEXT
    {
        $ffi = $this->ffi;
        $cValue = $this->cdata->maxFrameSize;
        $phpValue = new \iggyvolz\vulkan\struct\VkVideoEncodeH265FrameSizeEXT($cValue, $ffi);
        return $phpValue;
    }

    public function setMaxFrameSize(VkVideoEncodeH265FrameSizeEXT $phpValue): void
    {
        $ffi = $this->ffi;
        $cValue = $phpValue->cdata;
