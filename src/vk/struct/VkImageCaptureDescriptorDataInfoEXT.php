...
final class VkImageCaptureDescriptorDataInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImageCaptureDescriptorDataInfoEXT', false), $vulkan);
