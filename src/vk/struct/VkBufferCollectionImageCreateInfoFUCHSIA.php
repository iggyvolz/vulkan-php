...
final class VkBufferCollectionImageCreateInfoFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkBufferCollectionImageCreateInfoFUCHSIA', false), $vulkan);
