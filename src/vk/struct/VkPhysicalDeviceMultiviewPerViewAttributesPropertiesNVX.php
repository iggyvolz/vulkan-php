...
final class VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "perViewPositionAllComponents" => $this->getPerViewPositionAllComponents(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX', false), $vulkan);
