...
final class VkDescriptorBufferBindingPushDescriptorBufferHandleEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDescriptorBufferBindingPushDescriptorBufferHandleEXT', false), $vulkan->ffi);
