...
final class VkDescriptorBufferBindingPushDescriptorBufferHandleEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDescriptorBufferBindingPushDescriptorBufferHandleEXT', false), $vulkan);
