...
final class VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR', false), $vulkan);
