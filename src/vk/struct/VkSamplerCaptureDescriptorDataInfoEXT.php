...
final class VkSamplerCaptureDescriptorDataInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSamplerCaptureDescriptorDataInfoEXT', false), $vulkan);
