...
final class VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT', false), $vulkan->ffi);
