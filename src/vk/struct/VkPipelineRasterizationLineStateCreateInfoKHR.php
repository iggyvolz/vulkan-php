...
final class VkPipelineRasterizationLineStateCreateInfoKHR implements \JsonSerializable
{
    ...
    public static function create(
        ...
        null|\iggyvolz\vulkan\enum\VkLineRasterizationModeKHR $lineRasterizationMode = null,
        null|bool $stippledLineEnable = null,
        null|int $lineStippleFactor = null,
        null|int $lineStipplePattern = null,
    ): self
    {
        $self = new self( $vulkan->ffi->new('VkPipelineRasterizationLineStateCreateInfoKHR', false));
     ...
     */
    public function getLineRasterizationMode(): \iggyvolz\vulkan\enum\VkLineRasterizationModeKHR
    {
        $cValue = $this->cdata->lineRasterizationMode;
        $phpValue = \iggyvolz\vulkan\enum\VkLineRasterizationModeKHR::from($cValue);
        return $phpValue;
    }

    public function setLineRasterizationMode(\iggyvolz\vulkan\enum\VkLineRasterizationModeKHR $phpValue): void
    {
        $cValue = $phpValue->value;
