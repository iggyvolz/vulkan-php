...
final class VkPhysicalDeviceMaintenance5FeaturesKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "maintenance5" => $this->getMaintenance5(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMaintenance5FeaturesKHR', false), $vulkan);
