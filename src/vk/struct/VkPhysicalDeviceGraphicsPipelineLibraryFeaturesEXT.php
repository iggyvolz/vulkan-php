...
final class VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT', false), $vulkan->ffi);
