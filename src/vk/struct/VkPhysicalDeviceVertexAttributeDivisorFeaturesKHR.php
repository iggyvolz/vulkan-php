...
final class VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR', false), $vulkan->ffi);
