...
final class VkOpticalFlowImageFormatPropertiesNV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkOpticalFlowImageFormatPropertiesNV', false), $vulkan);
