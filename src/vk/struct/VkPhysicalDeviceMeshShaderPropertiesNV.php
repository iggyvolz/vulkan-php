...
final class VkPhysicalDeviceMeshShaderPropertiesNV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMeshShaderPropertiesNV', false), $vulkan);
