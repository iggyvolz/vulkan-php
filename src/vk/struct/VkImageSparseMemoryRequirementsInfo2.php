...
final class VkImageSparseMemoryRequirementsInfo2 implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImageSparseMemoryRequirementsInfo2', false), $vulkan);
