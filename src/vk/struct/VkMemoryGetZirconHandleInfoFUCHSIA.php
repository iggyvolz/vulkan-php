...
final class VkMemoryGetZirconHandleInfoFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkMemoryGetZirconHandleInfoFUCHSIA', false), $vulkan);
