...
final class VkVideoEncodeH265SessionParametersFeedbackInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265SessionParametersFeedbackInfoKHR', false), $vulkan->ffi);
