...
final class VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures', false), $vulkan->ffi);
