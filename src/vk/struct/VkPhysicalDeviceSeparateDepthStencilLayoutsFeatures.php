...
final class VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures', false), $vulkan);
