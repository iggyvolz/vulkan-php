...
final class VkImportMemoryZirconHandleInfoFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImportMemoryZirconHandleInfoFUCHSIA', false), $vulkan);
