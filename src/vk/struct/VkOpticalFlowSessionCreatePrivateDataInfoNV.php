...
final class VkOpticalFlowSessionCreatePrivateDataInfoNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "id" => $this->getId(),
          "size" => $this->getSize(),
          "pPrivateData" => $this->getPPrivateData(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkOpticalFlowSessionCreatePrivateDataInfoNV', false), $vulkan);
