...
final class VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceFragmentShadingRateEnumsPropertiesNV', false), $vulkan->ffi);
