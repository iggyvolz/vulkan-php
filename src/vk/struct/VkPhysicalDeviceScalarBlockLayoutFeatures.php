...
final class VkPhysicalDeviceScalarBlockLayoutFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceScalarBlockLayoutFeatures', false), $vulkan);
