...
final class VkCopyMemoryToAccelerationStructureInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCopyMemoryToAccelerationStructureInfoKHR', false), $vulkan);
