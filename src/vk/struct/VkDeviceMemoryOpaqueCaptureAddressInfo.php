...
final class VkDeviceMemoryOpaqueCaptureAddressInfo implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceMemoryOpaqueCaptureAddressInfo', false), $vulkan);
