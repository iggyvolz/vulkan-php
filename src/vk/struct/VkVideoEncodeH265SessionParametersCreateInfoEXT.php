...
final class VkVideoEncodeH265SessionParametersCreateInfoEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265SessionParametersCreateInfoEXT', false), $vulkan->ffi);
    ...
    public function getPParametersAddInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVideoEncodeH265SessionParametersAddInfoEXT', $cValue, $ffi);
        return $phpValue;
    }
