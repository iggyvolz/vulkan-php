...
final class VkSwapchainPresentBarrierCreateInfoNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "presentBarrierEnable" => $this->getPresentBarrierEnable(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSwapchainPresentBarrierCreateInfoNV', false), $vulkan);
