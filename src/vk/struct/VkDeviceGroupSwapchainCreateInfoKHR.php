...
final class VkDeviceGroupSwapchainCreateInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceGroupSwapchainCreateInfoKHR', false), $vulkan);
