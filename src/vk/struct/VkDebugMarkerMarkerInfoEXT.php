...
final class VkDebugMarkerMarkerInfoEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "pMarkerName" => $this->getPMarkerName(),
          "color" => $this->getColor(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDebugMarkerMarkerInfoEXT', false), $vulkan);
