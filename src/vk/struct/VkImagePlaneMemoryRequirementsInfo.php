...
final class VkImagePlaneMemoryRequirementsInfo implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImagePlaneMemoryRequirementsInfo', false), $vulkan);
