...
final class VkDeviceQueueShaderCoreControlCreateInfoARM implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceQueueShaderCoreControlCreateInfoARM', false), $vulkan);
