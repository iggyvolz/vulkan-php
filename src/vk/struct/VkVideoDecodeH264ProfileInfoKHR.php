...
final class VkVideoDecodeH264ProfileInfoKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "stdProfileIdc" => $this->getStdProfileIdc(),
          "pictureLayout" => $this->getPictureLayout(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoDecodeH264ProfileInfoKHR', false), $vulkan);
