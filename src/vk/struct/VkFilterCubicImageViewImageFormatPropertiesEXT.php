...
final class VkFilterCubicImageViewImageFormatPropertiesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkFilterCubicImageViewImageFormatPropertiesEXT', false), $vulkan->ffi);
