...
final class VkBufferCaptureDescriptorDataInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkBufferCaptureDescriptorDataInfoEXT', false), $vulkan);
