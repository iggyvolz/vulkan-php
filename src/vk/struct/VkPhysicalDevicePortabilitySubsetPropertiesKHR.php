...
final class VkPhysicalDevicePortabilitySubsetPropertiesKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePortabilitySubsetPropertiesKHR', false), $vulkan->ffi);
