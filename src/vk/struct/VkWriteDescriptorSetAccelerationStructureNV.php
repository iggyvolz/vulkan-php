...
final class VkWriteDescriptorSetAccelerationStructureNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkWriteDescriptorSetAccelerationStructureNV', false), $vulkan->ffi);
    ...
    public function getPAccelerationStructures(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkAccelerationStructureNV', $cValue, $ffi);
        return $phpValue;
    }
