...
final class VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "dedicatedAllocationImageAliasing" => $this->getDedicatedAllocationImageAliasing(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV', false), $vulkan);
