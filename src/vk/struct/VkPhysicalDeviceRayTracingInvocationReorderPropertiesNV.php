...
final class VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV', false), $vulkan->ffi);
