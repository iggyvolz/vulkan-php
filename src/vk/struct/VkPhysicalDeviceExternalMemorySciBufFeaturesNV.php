...
final class VkPhysicalDeviceExternalMemorySciBufFeaturesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceExternalMemorySciBufFeaturesNV', false), $vulkan->ffi);
