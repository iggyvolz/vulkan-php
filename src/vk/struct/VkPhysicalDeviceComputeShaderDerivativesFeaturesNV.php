...
final class VkPhysicalDeviceComputeShaderDerivativesFeaturesNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceComputeShaderDerivativesFeaturesNV', false), $vulkan->ffi);
