...
final class VkRenderingFragmentShadingRateAttachmentInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkRenderingFragmentShadingRateAttachmentInfoKHR', false), $vulkan->ffi);
