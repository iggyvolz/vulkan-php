...
final class VkCopyAccelerationStructureToMemoryInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCopyAccelerationStructureToMemoryInfoKHR', false), $vulkan);
