...
final class VkPhysicalDeviceCooperativeMatrixFeaturesNV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceCooperativeMatrixFeaturesNV', false), $vulkan);
