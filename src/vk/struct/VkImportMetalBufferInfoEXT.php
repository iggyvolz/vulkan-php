...
final class VkImportMetalBufferInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImportMetalBufferInfoEXT', false), $vulkan);
