...
final class VkRenderingFragmentDensityMapAttachmentInfoEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkRenderingFragmentDensityMapAttachmentInfoEXT', false), $vulkan->ffi);
