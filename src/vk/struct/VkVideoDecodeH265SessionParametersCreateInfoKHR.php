...
final class VkVideoDecodeH265SessionParametersCreateInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoDecodeH265SessionParametersCreateInfoKHR', false), $vulkan->ffi);
    ...
    public function getPParametersAddInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVideoDecodeH265SessionParametersAddInfoKHR', $cValue, $ffi);
        return $phpValue;
    }
