...
final class VkPhysicalDeviceMemoryProperties2 implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "memoryProperties" => $this->getMemoryProperties(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMemoryProperties2', false), $vulkan);
