...
final class VkApplicationInfo implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "pApplicationName" => $this->getPApplicationName(),
          "applicationVersion" => $this->getApplicationVersion(),
          "pEngineName" => $this->getPEngineName(),
    ...
    {
        $self = new self( $vulkan->ffi->new('VkApplicationInfo', false), $vulkan);
