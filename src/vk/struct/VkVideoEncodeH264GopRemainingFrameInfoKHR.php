...
final class VkVideoEncodeH264GopRemainingFrameInfoKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "useGopRemainingFrames" => $this->getUseGopRemainingFrames(),
          "gopRemainingI" => $this->getGopRemainingI(),
          "gopRemainingP" => $this->getGopRemainingP(),
          "gopRemainingB" => $this->getGopRemainingB(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264GopRemainingFrameInfoKHR', false), $vulkan);
