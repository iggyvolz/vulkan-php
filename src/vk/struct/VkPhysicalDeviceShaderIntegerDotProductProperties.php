...
final class VkPhysicalDeviceShaderIntegerDotProductProperties
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderIntegerDotProductProperties', false), $vulkan->ffi);
