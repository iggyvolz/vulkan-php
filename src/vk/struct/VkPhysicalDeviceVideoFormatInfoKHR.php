...
final class VkPhysicalDeviceVideoFormatInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVideoFormatInfoKHR', false), $vulkan);
