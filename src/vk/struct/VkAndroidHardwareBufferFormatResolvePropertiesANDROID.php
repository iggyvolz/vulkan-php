...
final class VkAndroidHardwareBufferFormatResolvePropertiesANDROID
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkAndroidHardwareBufferFormatResolvePropertiesANDROID', false), $vulkan->ffi);
