...
final class VkSamplerBorderColorComponentMappingCreateInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSamplerBorderColorComponentMappingCreateInfoEXT', false), $vulkan);
