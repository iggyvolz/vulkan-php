...
final class VkPhysicalDeviceTimelineSemaphoreProperties implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceTimelineSemaphoreProperties', false), $vulkan);
