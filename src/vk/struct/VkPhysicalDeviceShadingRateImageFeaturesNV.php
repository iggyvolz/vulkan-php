...
final class VkPhysicalDeviceShadingRateImageFeaturesNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "shadingRateImage" => $this->getShadingRateImage(),
          "shadingRateCoarseSampleOrder" => $this->getShadingRateCoarseSampleOrder(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShadingRateImageFeaturesNV', false), $vulkan);
