...
final class VkVideoEncodeH265PictureInfoKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "naluSliceSegmentEntryCount" => $this->getNaluSliceSegmentEntryCount(),
          "pNaluSliceSegmentEntries" => $this->getPNaluSliceSegmentEntries(),
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265PictureInfoKHR', false), $vulkan);
