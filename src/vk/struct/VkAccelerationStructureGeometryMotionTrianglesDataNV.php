...
final class VkAccelerationStructureGeometryMotionTrianglesDataNV
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkAccelerationStructureGeometryMotionTrianglesDataNV', false), $vulkan->ffi);
