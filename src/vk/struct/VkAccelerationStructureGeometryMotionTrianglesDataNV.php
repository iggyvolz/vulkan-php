...
final class VkAccelerationStructureGeometryMotionTrianglesDataNV implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkAccelerationStructureGeometryMotionTrianglesDataNV', false), $vulkan);
