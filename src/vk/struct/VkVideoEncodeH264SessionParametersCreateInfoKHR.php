...
final class VkVideoEncodeH264SessionParametersCreateInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264SessionParametersCreateInfoKHR', false), $vulkan->ffi);
    ...
    public function getPParametersAddInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVideoEncodeH264SessionParametersAddInfoKHR', $cValue, $ffi);
        return $phpValue;
    }
