...
final class VkPhysicalDeviceDisplacementMicromapFeaturesNV implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "displacementMicromap" => $this->getDisplacementMicromap(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceDisplacementMicromapFeaturesNV', false), $vulkan);
