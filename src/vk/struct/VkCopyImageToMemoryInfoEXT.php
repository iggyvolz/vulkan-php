...
final class VkCopyImageToMemoryInfoEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCopyImageToMemoryInfoEXT', false), $vulkan->ffi);
    ...
    public function getPRegions(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkImageToMemoryCopyEXT', $cValue, $ffi);
        return $phpValue;
    }
