...
final class VkDeviceDeviceMemoryReportCreateInfoEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceDeviceMemoryReportCreateInfoEXT', false), $vulkan);
