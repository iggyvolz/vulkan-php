...
final class VkPhysicalDeviceProtectedMemoryFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceProtectedMemoryFeatures', false), $vulkan);
