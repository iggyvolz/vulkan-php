...
final class VkPipelineRasterizationProvokingVertexStateCreateInfoEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "provokingVertexMode" => $this->getProvokingVertexMode(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPipelineRasterizationProvokingVertexStateCreateInfoEXT', false), $vulkan);
