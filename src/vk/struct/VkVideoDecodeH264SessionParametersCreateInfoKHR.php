...
final class VkVideoDecodeH264SessionParametersCreateInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoDecodeH264SessionParametersCreateInfoKHR', false), $vulkan->ffi);
    ...
    public function getPParametersAddInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVideoDecodeH264SessionParametersAddInfoKHR', $cValue, $ffi);
        return $phpValue;
    }
