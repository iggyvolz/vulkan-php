...
final class VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures', false));
