...
final class VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures', false), $vulkan->ffi);
