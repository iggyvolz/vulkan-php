...
final class VkDeviceGroupDeviceCreateInfo
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceGroupDeviceCreateInfo', false), $vulkan->ffi);
    ...
    public function getPPhysicalDevices(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkPhysicalDevice', $cValue, $ffi);
        return $phpValue;
    }
