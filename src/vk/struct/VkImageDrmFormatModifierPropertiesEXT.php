...
final class VkImageDrmFormatModifierPropertiesEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImageDrmFormatModifierPropertiesEXT', false), $vulkan);
