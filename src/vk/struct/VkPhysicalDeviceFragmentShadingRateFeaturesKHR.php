...
final class VkPhysicalDeviceFragmentShadingRateFeaturesKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceFragmentShadingRateFeaturesKHR', false), $vulkan->ffi);
