...
final class VkPhysicalDeviceVulkan11Features implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "protectedMemory" => $this->getProtectedMemory(),
          "samplerYcbcrConversion" => $this->getSamplerYcbcrConversion(),
          "shaderDrawParameters" => $this->getShaderDrawParameters(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVulkan11Features', false), $vulkan);
