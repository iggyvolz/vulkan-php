...
final class VkPhysicalDeviceTextureCompressionASTCHDRFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceTextureCompressionASTCHDRFeatures', false), $vulkan);
