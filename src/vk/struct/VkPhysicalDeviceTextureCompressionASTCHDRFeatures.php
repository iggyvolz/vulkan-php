...
final class VkPhysicalDeviceTextureCompressionASTCHDRFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceTextureCompressionASTCHDRFeatures', false), $vulkan->ffi);
