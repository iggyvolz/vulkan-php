...
final class VkQueueFamilyVideoPropertiesKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "videoCodecOperations" => $this->getVideoCodecOperations(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkQueueFamilyVideoPropertiesKHR', false), $vulkan);
