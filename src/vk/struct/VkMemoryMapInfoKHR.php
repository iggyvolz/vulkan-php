...
final class VkMemoryMapInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkMemoryMapInfoKHR', false));
    ...
    public function getFlags(): array
    {
        ...
        $phpValue = \iggyvolz\vulkan\enum\VkMemoryMapFlagBits::fromInt($cValue);
        return $phpValue;
    }

    public function setFlags(array $phpValue): void
    {
        $cValue = \iggyvolz\vulkan\enum\VkMemoryMapFlagBits::toInt(...$phpValue);
