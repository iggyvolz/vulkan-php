...
final class VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT', false), $vulkan->ffi);
