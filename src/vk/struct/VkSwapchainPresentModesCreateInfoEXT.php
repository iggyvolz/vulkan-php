...
final class VkSwapchainPresentModesCreateInfoEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "presentModeCount" => $this->getPresentModeCount(),
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSwapchainPresentModesCreateInfoEXT', false), $vulkan);
