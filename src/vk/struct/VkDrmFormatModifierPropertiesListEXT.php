...
final class VkDrmFormatModifierPropertiesListEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDrmFormatModifierPropertiesListEXT', false), $vulkan);
