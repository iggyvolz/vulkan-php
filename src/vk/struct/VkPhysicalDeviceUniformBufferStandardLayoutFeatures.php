...
final class VkPhysicalDeviceUniformBufferStandardLayoutFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceUniformBufferStandardLayoutFeatures', false), $vulkan);
