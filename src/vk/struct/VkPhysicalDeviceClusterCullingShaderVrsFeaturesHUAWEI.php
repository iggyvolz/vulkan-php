...
final class VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "clusterShadingRate" => $this->getClusterShadingRate(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI', false), $vulkan);
