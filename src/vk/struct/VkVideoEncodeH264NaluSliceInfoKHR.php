...
final class VkVideoEncodeH264NaluSliceInfoKHR implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "pStdSliceHeader" => $this->getPStdSliceHeader(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH264NaluSliceInfoKHR', false), $vulkan);
