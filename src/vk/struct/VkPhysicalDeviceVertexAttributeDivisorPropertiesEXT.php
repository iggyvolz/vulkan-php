...
final class VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT', false), $vulkan);
