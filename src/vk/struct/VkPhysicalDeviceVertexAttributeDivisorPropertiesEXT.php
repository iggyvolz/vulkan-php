...
final class VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT', false), $vulkan->ffi);
