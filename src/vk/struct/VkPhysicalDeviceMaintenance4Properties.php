...
final class VkPhysicalDeviceMaintenance4Properties implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMaintenance4Properties', false));
