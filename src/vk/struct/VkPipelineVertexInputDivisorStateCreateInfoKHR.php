...
final class VkPipelineVertexInputDivisorStateCreateInfoKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPipelineVertexInputDivisorStateCreateInfoKHR', false), $vulkan->ffi);
    ...
    public function getPVertexBindingDivisors(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkVertexInputBindingDivisorDescriptionKHR', $cValue, $ffi);
        return $phpValue;
    }
