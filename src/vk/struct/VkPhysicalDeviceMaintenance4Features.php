...
final class VkPhysicalDeviceMaintenance4Features implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceMaintenance4Features', false), $vulkan);
