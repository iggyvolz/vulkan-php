...
final class VkVideoEncodeH265GopRemainingFrameInfoKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkVideoEncodeH265GopRemainingFrameInfoKHR', false), $vulkan);
