...
final class VkPhysicalDeviceTimelineSemaphoreFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceTimelineSemaphoreFeatures', false), $vulkan);
