...
final class VkPhysicalDeviceHostQueryResetFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceHostQueryResetFeatures', false), $vulkan);
