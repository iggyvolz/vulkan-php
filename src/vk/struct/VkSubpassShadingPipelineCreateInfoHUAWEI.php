...
final class VkSubpassShadingPipelineCreateInfoHUAWEI implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSubpassShadingPipelineCreateInfoHUAWEI', false), $vulkan);
