...
final class VkImageViewSampleWeightCreateInfoQCOM implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "filterCenter" => $this->getFilterCenter(),
          "filterSize" => $this->getFilterSize(),
          "numPhases" => $this->getNumPhases(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkImageViewSampleWeightCreateInfoQCOM', false), $vulkan);
