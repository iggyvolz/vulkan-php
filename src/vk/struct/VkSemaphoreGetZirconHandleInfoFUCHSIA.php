...
final class VkSemaphoreGetZirconHandleInfoFUCHSIA implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkSemaphoreGetZirconHandleInfoFUCHSIA', false), $vulkan);
