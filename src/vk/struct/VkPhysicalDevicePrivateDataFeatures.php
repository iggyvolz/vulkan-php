...
final class VkPhysicalDevicePrivateDataFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePrivateDataFeatures', false), $vulkan);
