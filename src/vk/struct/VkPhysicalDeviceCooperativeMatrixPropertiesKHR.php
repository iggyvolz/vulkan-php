...
final class VkPhysicalDeviceCooperativeMatrixPropertiesKHR
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceCooperativeMatrixPropertiesKHR', false), $vulkan->ffi);
