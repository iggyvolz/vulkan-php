...
final class VkPhysicalDeviceCooperativeMatrixPropertiesKHR implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceCooperativeMatrixPropertiesKHR', false), $vulkan);
