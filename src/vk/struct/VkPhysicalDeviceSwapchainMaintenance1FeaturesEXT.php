...
final class VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceSwapchainMaintenance1FeaturesEXT', false), $vulkan->ffi);
