...
final class VkDeviceBufferMemoryRequirements
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkDeviceBufferMemoryRequirements', false), $vulkan->ffi);
    ...
    public function getPCreateInfo(): \iggyvolz\vulkan\util\ObjectPointer
    {
        ...
        $phpValue = new \iggyvolz\vulkan\util\ObjectPointer('VkBufferCreateInfo', $cValue, $ffi);
        return $phpValue;
    }
