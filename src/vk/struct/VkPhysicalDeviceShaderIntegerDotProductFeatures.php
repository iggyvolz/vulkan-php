...
final class VkPhysicalDeviceShaderIntegerDotProductFeatures implements \JsonSerializable
{
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderIntegerDotProductFeatures', false), $vulkan);
