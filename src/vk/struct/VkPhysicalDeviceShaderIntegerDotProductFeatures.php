...
final class VkPhysicalDeviceShaderIntegerDotProductFeatures
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceShaderIntegerDotProductFeatures', false), $vulkan->ffi);
