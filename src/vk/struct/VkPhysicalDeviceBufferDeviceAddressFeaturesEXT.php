...
final class VkPhysicalDeviceBufferDeviceAddressFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceBufferDeviceAddressFeaturesEXT', false), $vulkan->ffi);
