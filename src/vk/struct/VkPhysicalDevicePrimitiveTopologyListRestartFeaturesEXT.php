...
final class VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "sType" => $this->getSType(),
          "pNext" => $this->getPNext(),
          "primitiveTopologyListRestart" => $this->getPrimitiveTopologyListRestart(),
          "primitiveTopologyPatchListRestart" => $this->getPrimitiveTopologyPatchListRestart(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT', false), $vulkan);
