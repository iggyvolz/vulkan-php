...
final class VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT', false), $vulkan->ffi);
