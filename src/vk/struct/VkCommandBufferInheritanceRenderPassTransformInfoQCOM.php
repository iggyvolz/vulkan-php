...
final class VkCommandBufferInheritanceRenderPassTransformInfoQCOM
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkCommandBufferInheritanceRenderPassTransformInfoQCOM', false), $vulkan->ffi);
