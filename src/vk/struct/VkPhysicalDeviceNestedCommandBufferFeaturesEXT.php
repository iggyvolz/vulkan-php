...
final class VkPhysicalDeviceNestedCommandBufferFeaturesEXT
{
    /**
     * @internal
     */
    ...
    {
        $self = new self( $vulkan->ffi->new('VkPhysicalDeviceNestedCommandBufferFeaturesEXT', false), $vulkan->ffi);
