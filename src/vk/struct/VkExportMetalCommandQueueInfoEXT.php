...
final class VkExportMetalCommandQueueInfoEXT implements \JsonSerializable
{
    public function jsonSerialize(): array
    {
        return [
          ...
          "pNext" => $this->getPNext(),
          "queue" => $this->getQueue(),
          "mtlCommandQueue" => $this->getMtlCommandQueue(),
        ];
    }
    ...
    {
        $self = new self( $vulkan->ffi->new('VkExportMetalCommandQueueInfoEXT', false), $vulkan);
