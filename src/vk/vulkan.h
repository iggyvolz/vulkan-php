...
typedef struct {uint32_t apiVersion ;uint32_t driverVersion ;uint32_t vendorID ;uint32_t deviceID ;VkPhysicalDeviceType deviceType ;char deviceName [256];char pipelineCacheUUID [16];void* limits ;void* sparseProperties ;} VkPhysicalDeviceProperties;
...
typedef struct {uint32_t headerSize ;VkPipelineCacheHeaderVersion headerVersion ;uint32_t vendorID ;uint32_t deviceID ;char pipelineCacheUUID [16];} VkPipelineCacheHeaderVersionOne;
typedef struct {uint64_t codeSize ;uint64_t codeOffset ;} VkPipelineCacheStageValidationIndexEntry;
typedef struct {char pipelineIdentifier [16];uint64_t pipelineMemorySize ;uint64_t jsonSize ;uint64_t jsonOffset ;uint32_t stageIndexCount ;uint32_t stageIndexStride ;uint64_t stageIndexOffset ;} VkPipelineCacheSafetyCriticalIndexEntry;
...
typedef struct {VkStructureType sType ;void* pNext ;char deviceUUID [16];char driverUUID [16];void* deviceLUID ;uint32_t deviceNodeMask ;uint32_t deviceLUIDValid ;} VkPhysicalDeviceIDProperties;
...
typedef struct {VkStructureType sType ;void* pNext ;VkPerformanceCounterUnitKHR unit ;VkPerformanceCounterScopeKHR scope ;VkPerformanceCounterStorageKHR storage ;char uuid [16];} VkPerformanceCounterKHR;
...
typedef struct {VkStructureType sType ;void* pNext ;uint32_t indexTypeUint8 ;} VkPhysicalDeviceIndexTypeUint8FeaturesKHR;
...
typedef struct {VkStructureType sType ;void* pNext ;uint32_t rectangularLines ;uint32_t bresenhamLines ;uint32_t smoothLines ;uint32_t stippledRectangularLines ;uint32_t stippledBresenhamLines ;uint32_t stippledSmoothLines ;} VkPhysicalDeviceLineRasterizationFeaturesKHR;
typedef struct {} VkPhysicalDeviceLineRasterizationFeaturesEXT;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t lineSubPixelPrecisionBits ;} VkPhysicalDeviceLineRasterizationPropertiesKHR;
typedef struct {} VkPhysicalDeviceLineRasterizationPropertiesEXT;
typedef struct {VkStructureType sType ;void* pNext ;VkLineRasterizationModeKHR lineRasterizationMode ;uint32_t stippledLineEnable ;uint32_t lineStippleFactor ;uint16_t lineStipplePattern ;} VkPipelineRasterizationLineStateCreateInfoKHR;
...
typedef struct {VkStructureType sType ;void* pNext ;char pipelineIdentifier [16];VkPipelineMatchControl matchControl ;uint64_t poolEntrySize ;} VkPipelineOfflineCreateInfo;
...
typedef struct {VkStructureType sType ;void* pNext ;uint32_t copySrcLayoutCount ;void* pCopySrcLayouts ;uint32_t copyDstLayoutCount ;void* pCopyDstLayouts ;char optimalTilingLayoutUUID [16];uint32_t identicalMemoryTypeRequirements ;} VkPhysicalDeviceHostImageCopyPropertiesEXT;
...
typedef struct {VkStructureType sType ;void* pNext ;void* stdProfile ;uint32_t filmGrainSupport ;} VkVideoDecodeAV1ProfileInfoKHR;
typedef struct {VkStructureType sType ;void* pNext ;void* maxLevel ;} VkVideoDecodeAV1CapabilitiesKHR;
typedef struct {VkStructureType sType ;void* pNext ;void* pStdSequenceHeader ;} VkVideoDecodeAV1SessionParametersCreateInfoKHR;
typedef struct {VkStructureType sType ;void* pNext ;void* pStdPictureInfo ;void* referenceNameSlotIndices ;uint32_t frameHeaderOffset ;uint32_t tileCount ;uint32_t* pTileOffsets ;uint32_t* pTileSizes ;} VkVideoDecodeAV1PictureInfoKHR;
typedef struct {VkStructureType sType ;void* pNext ;void* pStdReferenceInfo ;} VkVideoDecodeAV1DpbSlotInfoKHR;
...
typedef struct {VkStructureType sType ;void* pNext ;uint32_t rayTracingValidation ;} VkPhysicalDeviceRayTracingValidationFeaturesNV;
...
typedef struct {VkStructureType sType ;void* pNext ;char shaderModuleIdentifierAlgorithmUUID [16];} VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT;
...
typedef struct {VkStructureType sType ;void* pNext ;char pipelineIdentifier [16];} VkPipelinePropertiesIdentifierEXT;
...
typedef struct {VkStructureType sType ;void* pNext ;char shaderBinaryUUID [16];uint32_t shaderBinaryVersion ;} VkPhysicalDeviceShaderObjectPropertiesEXT;
...
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderMaximalReconvergence ;} VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderSubgroupRotate ;uint32_t shaderSubgroupRotateClustered ;} VkPhysicalDeviceShaderSubgroupRotateFeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderExpectAssume ;} VkPhysicalDeviceShaderExpectAssumeFeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderFloatControls2 ;} VkPhysicalDeviceShaderFloatControls2FeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t dynamicRenderingLocalRead ;} VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t colorAttachmentCount ;uint32_t* pColorAttachmentLocations ;} VkRenderingAttachmentLocationInfoKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t colorAttachmentCount ;uint32_t* pColorAttachmentInputIndices ;uint32_t* pDepthInputAttachmentIndex ;uint32_t* pStencilInputAttachmentIndex ;} VkRenderingInputAttachmentIndexInfoKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderQuadControl ;} VkPhysicalDeviceShaderQuadControlFeaturesKHR;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderFloat16VectorAtomics ;} VkPhysicalDeviceShaderAtomicFloat16VectorFeaturesNV;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t memoryMapPlaced ;uint32_t memoryMapRangePlaced ;uint32_t memoryUnmapReserve ;} VkPhysicalDeviceMapMemoryPlacedFeaturesEXT;
typedef struct {VkStructureType sType ;void* pNext ;uint64_t minPlacedMemoryMapAlignment ;} VkPhysicalDeviceMapMemoryPlacedPropertiesEXT;
typedef struct {VkStructureType sType ;void* pNext ;void* pPlacedAddress ;} VkMemoryMapPlacedInfoEXT;
typedef struct {VkStructureType sType ;void* pNext ;uint32_t shaderRawAccessChains ;} VkPhysicalDeviceRawAccessChainsFeaturesNV;
...
typedef void (*PFN_PHP_vkCmdSetLineStippleKHR)(VkCommandBuffer commandBuffer,uint32_t lineStippleFactor,uint16_t lineStipplePattern);
...
typedef void (*PFN_PHP_vkCmdSetLineRasterizationModeEXT)(VkCommandBuffer commandBuffer,void* lineRasterizationMode);
...
typedef void (*PFN_PHP_vkCmdSetRenderingAttachmentLocationsKHR)(VkCommandBuffer commandBuffer,VkRenderingAttachmentLocationInfoKHR* pLocationInfo);
typedef void (*PFN_PHP_vkCmdSetRenderingInputAttachmentIndicesKHR)(VkCommandBuffer commandBuffer,VkRenderingInputAttachmentIndexInfoKHR* pLocationInfo);
