...
class VkExtShaderObject
{
    ...
    public function vkCmdSetDepthClampEnableEXT()
    {
    }
    ...
    public function vkCmdSetAlphaToOneEnableEXT()
    {
    }

    public function vkCmdSetLogicOpEnableEXT()
    {
    }
    ...
    public function vkCmdSetDepthClipEnableEXT()
    {
    }
