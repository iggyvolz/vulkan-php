...
final class CDefs implements \Stringable
{
    ...
    public function __construct()
    {
        ...
        $this->cdefs[] = 'typedef int VkVideoEncodeH264CapabilityFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264StdFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264RateControlFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CapabilityFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265StdFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265RateControlFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CtbSizeFlagsEXT;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265TransformBlockSizeFlagsEXT;';
