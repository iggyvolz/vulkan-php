...
final class CDefs implements \Stringable
{
    ...
    public function __construct()
    {
        ...
        $this->cdefs[] = 'typedef int VkTimeDomainKHR;';
        ...
        $this->cdefs[] = 'typedef int VkLayerSettingTypeEXT;';
        ...
        $this->cdefs[] = 'typedef int VkVideoEncodeH264CapabilityFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264StdFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264RateControlFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CapabilityFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265StdFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265RateControlFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CtbSizeFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265TransformBlockSizeFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureMotionInstanceTypeNV;';
        $this->cdefs[] = 'typedef int VkFramebufferCreateFlags;';
        $this->cdefs[] = 'typedef int VkQueryPoolCreateFlags;';
        $this->cdefs[] = 'typedef int VkRenderPassCreateFlags;';
        $this->cdefs[] = 'typedef int VkSamplerCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineLayoutCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineCacheCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineDepthStencilStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineDynamicStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineColorBlendStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineMultisampleStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineRasterizationStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineViewportStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineTessellationStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineInputAssemblyStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineVertexInputStateCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineShaderStageCreateFlags;';
        $this->cdefs[] = 'typedef int VkDescriptorSetLayoutCreateFlags;';
        $this->cdefs[] = 'typedef int VkBufferViewCreateFlags;';
        $this->cdefs[] = 'typedef int VkInstanceCreateFlags;';
        $this->cdefs[] = 'typedef int VkDeviceCreateFlags;';
        $this->cdefs[] = 'typedef int VkDeviceQueueCreateFlags;';
        $this->cdefs[] = 'typedef int VkQueueFlags;';
        $this->cdefs[] = 'typedef int VkMemoryPropertyFlags;';
        $this->cdefs[] = 'typedef int VkMemoryHeapFlags;';
        $this->cdefs[] = 'typedef int VkAccessFlags;';
        $this->cdefs[] = 'typedef int VkBufferUsageFlags;';
        $this->cdefs[] = 'typedef int VkBufferCreateFlags;';
        $this->cdefs[] = 'typedef int VkShaderStageFlags;';
        $this->cdefs[] = 'typedef int VkImageUsageFlags;';
        $this->cdefs[] = 'typedef int VkImageCreateFlags;';
        $this->cdefs[] = 'typedef int VkImageViewCreateFlags;';
        $this->cdefs[] = 'typedef int VkPipelineCreateFlags;';
        $this->cdefs[] = 'typedef int VkColorComponentFlags;';
        $this->cdefs[] = 'typedef int VkFenceCreateFlags;';
        $this->cdefs[] = 'typedef int VkSemaphoreCreateFlags;';
        $this->cdefs[] = 'typedef int VkFormatFeatureFlags;';
        $this->cdefs[] = 'typedef int VkQueryControlFlags;';
        $this->cdefs[] = 'typedef int VkQueryResultFlags;';
        $this->cdefs[] = 'typedef int VkShaderModuleCreateFlags;';
        $this->cdefs[] = 'typedef int VkEventCreateFlags;';
        $this->cdefs[] = 'typedef int VkCommandPoolCreateFlags;';
        $this->cdefs[] = 'typedef int VkCommandPoolResetFlags;';
        $this->cdefs[] = 'typedef int VkCommandBufferResetFlags;';
        $this->cdefs[] = 'typedef int VkCommandBufferUsageFlags;';
        $this->cdefs[] = 'typedef int VkQueryPipelineStatisticFlags;';
        $this->cdefs[] = 'typedef int VkMemoryMapFlags;';
        $this->cdefs[] = 'typedef int VkMemoryUnmapFlagsKHR;';
        $this->cdefs[] = 'typedef int VkImageAspectFlags;';
        $this->cdefs[] = 'typedef int VkSparseMemoryBindFlags;';
        $this->cdefs[] = 'typedef int VkSparseImageFormatFlags;';
        $this->cdefs[] = 'typedef int VkSubpassDescriptionFlags;';
        $this->cdefs[] = 'typedef int VkPipelineStageFlags;';
        $this->cdefs[] = 'typedef int VkSampleCountFlags;';
        $this->cdefs[] = 'typedef int VkAttachmentDescriptionFlags;';
        $this->cdefs[] = 'typedef int VkStencilFaceFlags;';
        $this->cdefs[] = 'typedef int VkCullModeFlags;';
        $this->cdefs[] = 'typedef int VkDescriptorPoolCreateFlags;';
        $this->cdefs[] = 'typedef int VkDescriptorPoolResetFlags;';
        $this->cdefs[] = 'typedef int VkDependencyFlags;';
        $this->cdefs[] = 'typedef int VkSubgroupFeatureFlags;';
        $this->cdefs[] = 'typedef int VkIndirectCommandsLayoutUsageFlagsNV;';
        $this->cdefs[] = 'typedef int VkIndirectStateFlagsNV;';
        $this->cdefs[] = 'typedef int VkGeometryFlagsKHR;';
        $this->cdefs[] = 'typedef int VkGeometryFlagsNV;';
        $this->cdefs[] = 'typedef int VkGeometryInstanceFlagsKHR;';
        $this->cdefs[] = 'typedef int VkGeometryInstanceFlagsNV;';
        $this->cdefs[] = 'typedef int VkBuildAccelerationStructureFlagsKHR;';
        $this->cdefs[] = 'typedef int VkBuildAccelerationStructureFlagsNV;';
        $this->cdefs[] = 'typedef int VkPrivateDataSlotCreateFlags;';
        $this->cdefs[] = 'typedef int VkPrivateDataSlotCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDescriptorUpdateTemplateCreateFlags;';
        $this->cdefs[] = 'typedef int VkDescriptorUpdateTemplateCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkPipelineCreationFeedbackFlags;';
        $this->cdefs[] = 'typedef int VkPipelineCreationFeedbackFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPerformanceCounterDescriptionFlagsKHR;';
        $this->cdefs[] = 'typedef int VkAcquireProfilingLockFlagsKHR;';
        $this->cdefs[] = 'typedef int VkSemaphoreWaitFlags;';
        $this->cdefs[] = 'typedef int VkSemaphoreWaitFlagsKHR;';
        $this->cdefs[] = 'typedef int VkPipelineCompilerControlFlagsAMD;';
        $this->cdefs[] = 'typedef int VkShaderCorePropertiesFlagsAMD;';
        $this->cdefs[] = 'typedef int VkDeviceDiagnosticsConfigFlagsNV;';
        $this->cdefs[] = 'typedef int VkRefreshObjectFlagsKHR;';
        $this->cdefs[] = 'typedef int VkAccessFlags2;';
        $this->cdefs[] = 'typedef int VkAccessFlags2KHR;';
        $this->cdefs[] = 'typedef int VkPipelineStageFlags2;';
        $this->cdefs[] = 'typedef int VkPipelineStageFlags2KHR;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureMotionInfoFlagsNV;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureMotionInstanceFlagsNV;';
        $this->cdefs[] = 'typedef int VkFormatFeatureFlags2;';
        $this->cdefs[] = 'typedef int VkFormatFeatureFlags2KHR;';
        $this->cdefs[] = 'typedef int VkRenderingFlags;';
        $this->cdefs[] = 'typedef int VkMemoryDecompressionMethodFlagsNV;';
        $this->cdefs[] = 'typedef int VkRenderingFlagsKHR;';
        $this->cdefs[] = 'typedef int VkBuildMicromapFlagsEXT;';
        $this->cdefs[] = 'typedef int VkMicromapCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDirectDriverLoadingFlagsLUNARG;';
        $this->cdefs[] = 'typedef int VkPipelineCreateFlags2KHR;';
        $this->cdefs[] = 'typedef int VkBufferUsageFlags2KHR;';
        $this->cdefs[] = 'typedef int VkCompositeAlphaFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDisplayPlaneAlphaFlagsKHR;';
        $this->cdefs[] = 'typedef int VkSurfaceTransformFlagsKHR;';
        $this->cdefs[] = 'typedef int VkSwapchainCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDisplayModeCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDisplaySurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkAndroidSurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkViSurfaceCreateFlagsNN;';
        $this->cdefs[] = 'typedef int VkWaylandSurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkWin32SurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkXlibSurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkXcbSurfaceCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDirectFBSurfaceCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkIOSSurfaceCreateFlagsMVK;';
        $this->cdefs[] = 'typedef int VkMacOSSurfaceCreateFlagsMVK;';
        $this->cdefs[] = 'typedef int VkMetalSurfaceCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkImagePipeSurfaceCreateFlagsFUCHSIA;';
        $this->cdefs[] = 'typedef int VkStreamDescriptorSurfaceCreateFlagsGGP;';
        $this->cdefs[] = 'typedef int VkHeadlessSurfaceCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkScreenSurfaceCreateFlagsQNX;';
        $this->cdefs[] = 'typedef int VkPeerMemoryFeatureFlags;';
        $this->cdefs[] = 'typedef int VkPeerMemoryFeatureFlagsKHR;';
        $this->cdefs[] = 'typedef int VkMemoryAllocateFlags;';
        $this->cdefs[] = 'typedef int VkMemoryAllocateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDeviceGroupPresentModeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkDebugReportFlagsEXT;';
        $this->cdefs[] = 'typedef int VkCommandPoolTrimFlags;';
        $this->cdefs[] = 'typedef int VkCommandPoolTrimFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalMemoryHandleTypeFlagsNV;';
        $this->cdefs[] = 'typedef int VkExternalMemoryFeatureFlagsNV;';
        $this->cdefs[] = 'typedef int VkExternalMemoryHandleTypeFlags;';
        $this->cdefs[] = 'typedef int VkExternalMemoryHandleTypeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalMemoryFeatureFlags;';
        $this->cdefs[] = 'typedef int VkExternalMemoryFeatureFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreHandleTypeFlags;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreHandleTypeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreFeatureFlags;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreFeatureFlagsKHR;';
        $this->cdefs[] = 'typedef int VkSemaphoreImportFlags;';
        $this->cdefs[] = 'typedef int VkSemaphoreImportFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalFenceHandleTypeFlags;';
        $this->cdefs[] = 'typedef int VkExternalFenceHandleTypeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkExternalFenceFeatureFlags;';
        $this->cdefs[] = 'typedef int VkExternalFenceFeatureFlagsKHR;';
        $this->cdefs[] = 'typedef int VkFenceImportFlags;';
        $this->cdefs[] = 'typedef int VkFenceImportFlagsKHR;';
        $this->cdefs[] = 'typedef int VkSurfaceCounterFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPipelineViewportSwizzleStateCreateFlagsNV;';
        $this->cdefs[] = 'typedef int VkPipelineDiscardRectangleStateCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPipelineCoverageToColorStateCreateFlagsNV;';
        $this->cdefs[] = 'typedef int VkPipelineCoverageModulationStateCreateFlagsNV;';
        $this->cdefs[] = 'typedef int VkPipelineCoverageReductionStateCreateFlagsNV;';
        $this->cdefs[] = 'typedef int VkValidationCacheCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDebugUtilsMessageSeverityFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDebugUtilsMessageTypeFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDebugUtilsMessengerCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDebugUtilsMessengerCallbackDataFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDeviceMemoryReportFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPipelineRasterizationConservativeStateCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDescriptorBindingFlags;';
        $this->cdefs[] = 'typedef int VkDescriptorBindingFlagsEXT;';
        $this->cdefs[] = 'typedef int VkConditionalRenderingFlagsEXT;';
        $this->cdefs[] = 'typedef int VkResolveModeFlags;';
        $this->cdefs[] = 'typedef int VkResolveModeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkPipelineRasterizationStateStreamCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPipelineRasterizationDepthClipStateCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkSwapchainImageUsageFlagsANDROID;';
        $this->cdefs[] = 'typedef int VkToolPurposeFlags;';
        $this->cdefs[] = 'typedef int VkToolPurposeFlagsEXT;';
        $this->cdefs[] = 'typedef int VkSubmitFlags;';
        $this->cdefs[] = 'typedef int VkSubmitFlagsKHR;';
        $this->cdefs[] = 'typedef int VkImageFormatConstraintsFlagsFUCHSIA;';
        $this->cdefs[] = 'typedef int VkHostImageCopyFlagsEXT;';
        $this->cdefs[] = 'typedef int VkImageConstraintsInfoFlagsFUCHSIA;';
        $this->cdefs[] = 'typedef int VkGraphicsPipelineLibraryFlagsEXT;';
        $this->cdefs[] = 'typedef int VkImageCompressionFlagsEXT;';
        $this->cdefs[] = 'typedef int VkImageCompressionFixedRateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkExportMetalObjectTypeFlagsEXT;';
        $this->cdefs[] = 'typedef int VkDeviceAddressBindingFlagsEXT;';
        $this->cdefs[] = 'typedef int VkOpticalFlowGridSizeFlagsNV;';
        $this->cdefs[] = 'typedef int VkOpticalFlowUsageFlagsNV;';
        $this->cdefs[] = 'typedef int VkOpticalFlowSessionCreateFlagsNV;';
        $this->cdefs[] = 'typedef int VkOpticalFlowExecuteFlagsNV;';
        $this->cdefs[] = 'typedef int VkFrameBoundaryFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPresentScalingFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPresentGravityFlagsEXT;';
        $this->cdefs[] = 'typedef int VkShaderCreateFlagsEXT;';
        $this->cdefs[] = 'typedef int VkPhysicalDeviceSchedulingControlsFlagsARM;';
        $this->cdefs[] = 'typedef int VkVideoCodecOperationFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoCapabilityFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoSessionCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoSessionParametersCreateFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoBeginCodingFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEndCodingFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoCodingControlFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoDecodeUsageFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoDecodeCapabilityFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoDecodeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoDecodeH264PictureLayoutFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeUsageFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeContentFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeCapabilityFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeFeedbackFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeRateControlFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeRateControlModeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoChromaSubsamplingFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoComponentBitDepthFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264CapabilityFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264StdFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH264RateControlFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CapabilityFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265StdFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265RateControlFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265CtbSizeFlagsKHR;';
        $this->cdefs[] = 'typedef int VkVideoEncodeH265TransformBlockSizeFlagsKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t settingCount ;void* pSettings ;} VkLayerSettingsCreateInfoEXT;';
        $this->cdefs[] = 'typedef struct {const char* pLayerName ;const char* pSettingName ;VkLayerSettingTypeEXT type ;uint32_t valueCount ;void* pValues ;} VkLayerSettingEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t maintenance6 ;} VkPhysicalDeviceMaintenance6FeaturesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t blockTexelViewCompatibleMultipleLayers ;uint32_t maxCombinedImageSamplerDescriptorCount ;uint32_t fragmentShadingRateClampCombinerInputs ;} VkPhysicalDeviceMaintenance6PropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkTimeDomainKHR timeDomain ;} VkCalibratedTimestampInfoKHR;';
        $this->cdefs[] = 'typedef struct {} VkCalibratedTimestampInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {uint32_t binding ;uint32_t divisor ;} VkVertexInputBindingDivisorDescriptionKHR;';
        $this->cdefs[] = 'typedef struct {} VkVertexInputBindingDivisorDescriptionEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t vertexBindingDivisorCount ;VkVertexInputBindingDivisorDescriptionKHR* pVertexBindingDivisors ;} VkPipelineVertexInputDivisorStateCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {} VkPipelineVertexInputDivisorStateCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t maxVertexAttribDivisor ;uint32_t supportsNonZeroFirstInstance ;} VkPhysicalDeviceVertexAttributeDivisorPropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t vertexAttributeInstanceRateDivisor ;uint32_t vertexAttributeInstanceRateZeroDivisor ;} VkPhysicalDeviceVertexAttributeDivisorFeaturesKHR;';
        $this->cdefs[] = 'typedef struct {} VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t clusterShadingRate ;} VkPhysicalDeviceClusterCullingShaderVrsFeaturesHUAWEI;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t videoMaintenance1 ;} VkPhysicalDeviceVideoMaintenance1FeaturesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkQueryPool queryPool ;uint32_t firstQuery ;uint32_t queryCount ;} VkVideoInlineQueryInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH264CapabilityFlagsKHR flags ;void* maxLevelIdc ;uint32_t maxSliceCount ;uint32_t maxPPictureL0ReferenceCount ;uint32_t maxBPictureL0ReferenceCount ;uint32_t maxL1ReferenceCount ;uint32_t maxTemporalLayerCount ;uint32_t expectDyadicTemporalLayerPattern ;int32_t minQp ;int32_t maxQp ;uint32_t prefersGopRemainingFrames ;uint32_t requiresGopRemainingFrames ;VkVideoEncodeH264StdFlagsKHR stdSyntaxFlags ;} VkVideoEncodeH264CapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH264RateControlFlagsKHR preferredRateControlFlags ;uint32_t preferredGopFrameCount ;uint32_t preferredIdrPeriod ;uint32_t preferredConsecutiveBFrameCount ;uint32_t preferredTemporalLayerCount ;void* preferredConstantQp ;uint32_t preferredMaxL0ReferenceCount ;uint32_t preferredMaxL1ReferenceCount ;uint32_t preferredStdEntropyCodingModeFlag ;} VkVideoEncodeH264QualityLevelPropertiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useMaxLevelIdc ;void* maxLevelIdc ;} VkVideoEncodeH264SessionCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t stdSPSCount ;void* pStdSPSs ;uint32_t stdPPSCount ;void* pStdPPSs ;} VkVideoEncodeH264SessionParametersAddInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t maxStdSPSCount ;uint32_t maxStdPPSCount ;VkVideoEncodeH264SessionParametersAddInfoKHR* pParametersAddInfo ;} VkVideoEncodeH264SessionParametersCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t writeStdSPS ;uint32_t writeStdPPS ;uint32_t stdSPSId ;uint32_t stdPPSId ;} VkVideoEncodeH264SessionParametersGetInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t hasStdSPSOverrides ;uint32_t hasStdPPSOverrides ;} VkVideoEncodeH264SessionParametersFeedbackInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* pStdReferenceInfo ;} VkVideoEncodeH264DpbSlotInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t naluSliceEntryCount ;void* pNaluSliceEntries ;void* pStdPictureInfo ;uint32_t generatePrefixNalu ;} VkVideoEncodeH264PictureInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* stdProfileIdc ;} VkVideoEncodeH264ProfileInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;int32_t constantQp ;void* pStdSliceHeader ;} VkVideoEncodeH264NaluSliceInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH264RateControlFlagsKHR flags ;uint32_t gopFrameCount ;uint32_t idrPeriod ;uint32_t consecutiveBFrameCount ;uint32_t temporalLayerCount ;} VkVideoEncodeH264RateControlInfoKHR;';
        $this->cdefs[] = 'typedef struct {int32_t qpI ;int32_t qpP ;int32_t qpB ;} VkVideoEncodeH264QpKHR;';
        $this->cdefs[] = 'typedef struct {uint32_t frameISize ;uint32_t framePSize ;uint32_t frameBSize ;} VkVideoEncodeH264FrameSizeKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useGopRemainingFrames ;uint32_t gopRemainingI ;uint32_t gopRemainingP ;uint32_t gopRemainingB ;} VkVideoEncodeH264GopRemainingFrameInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useMinQp ;void* minQp ;uint32_t useMaxQp ;void* maxQp ;uint32_t useMaxFrameSize ;VkVideoEncodeH264FrameSizeKHR maxFrameSize ;} VkVideoEncodeH264RateControlLayerInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH265CapabilityFlagsKHR flags ;void* maxLevelIdc ;uint32_t maxSliceSegmentCount ;VkExtent2D maxTiles ;VkVideoEncodeH265CtbSizeFlagsKHR ctbSizes ;VkVideoEncodeH265TransformBlockSizeFlagsKHR transformBlockSizes ;uint32_t maxPPictureL0ReferenceCount ;uint32_t maxBPictureL0ReferenceCount ;uint32_t maxL1ReferenceCount ;uint32_t maxSubLayerCount ;uint32_t expectDyadicTemporalSubLayerPattern ;int32_t minQp ;int32_t maxQp ;uint32_t prefersGopRemainingFrames ;uint32_t requiresGopRemainingFrames ;VkVideoEncodeH265StdFlagsKHR stdSyntaxFlags ;} VkVideoEncodeH265CapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH265RateControlFlagsKHR preferredRateControlFlags ;uint32_t preferredGopFrameCount ;uint32_t preferredIdrPeriod ;uint32_t preferredConsecutiveBFrameCount ;uint32_t preferredSubLayerCount ;void* preferredConstantQp ;uint32_t preferredMaxL0ReferenceCount ;uint32_t preferredMaxL1ReferenceCount ;} VkVideoEncodeH265QualityLevelPropertiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useMaxLevelIdc ;void* maxLevelIdc ;} VkVideoEncodeH265SessionCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t stdVPSCount ;void* pStdVPSs ;uint32_t stdSPSCount ;void* pStdSPSs ;uint32_t stdPPSCount ;void* pStdPPSs ;} VkVideoEncodeH265SessionParametersAddInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t maxStdVPSCount ;uint32_t maxStdSPSCount ;uint32_t maxStdPPSCount ;VkVideoEncodeH265SessionParametersAddInfoKHR* pParametersAddInfo ;} VkVideoEncodeH265SessionParametersCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t writeStdVPS ;uint32_t writeStdSPS ;uint32_t writeStdPPS ;uint32_t stdVPSId ;uint32_t stdSPSId ;uint32_t stdPPSId ;} VkVideoEncodeH265SessionParametersGetInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t hasStdVPSOverrides ;uint32_t hasStdSPSOverrides ;uint32_t hasStdPPSOverrides ;} VkVideoEncodeH265SessionParametersFeedbackInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t naluSliceSegmentEntryCount ;void* pNaluSliceSegmentEntries ;void* pStdPictureInfo ;} VkVideoEncodeH265PictureInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;int32_t constantQp ;void* pStdSliceSegmentHeader ;} VkVideoEncodeH265NaluSliceSegmentInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoEncodeH265RateControlFlagsKHR flags ;uint32_t gopFrameCount ;uint32_t idrPeriod ;uint32_t consecutiveBFrameCount ;uint32_t subLayerCount ;} VkVideoEncodeH265RateControlInfoKHR;';
        $this->cdefs[] = 'typedef struct {int32_t qpI ;int32_t qpP ;int32_t qpB ;} VkVideoEncodeH265QpKHR;';
        $this->cdefs[] = 'typedef struct {uint32_t frameISize ;uint32_t framePSize ;uint32_t frameBSize ;} VkVideoEncodeH265FrameSizeKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useGopRemainingFrames ;uint32_t gopRemainingI ;uint32_t gopRemainingP ;uint32_t gopRemainingB ;} VkVideoEncodeH265GopRemainingFrameInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t useMinQp ;void* minQp ;uint32_t useMaxQp ;void* maxQp ;uint32_t useMaxFrameSize ;VkVideoEncodeH265FrameSizeKHR maxFrameSize ;} VkVideoEncodeH265RateControlLayerInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* stdProfileIdc ;} VkVideoEncodeH265ProfileInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* pStdReferenceInfo ;} VkVideoEncodeH265DpbSlotInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* pResult ;} VkBindMemoryStatusKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkShaderStageFlags stageFlags ;VkPipelineLayout layout ;uint32_t firstSet ;uint32_t descriptorSetCount ;VkDescriptorSet* pDescriptorSets ;uint32_t dynamicOffsetCount ;uint32_t* pDynamicOffsets ;} VkBindDescriptorSetsInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkPipelineLayout layout ;VkShaderStageFlags stageFlags ;uint32_t offset ;uint32_t size ;void* pValues ;} VkPushConstantsInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkShaderStageFlags stageFlags ;VkPipelineLayout layout ;uint32_t set ;uint32_t descriptorWriteCount ;VkWriteDescriptorSet* pDescriptorWrites ;} VkPushDescriptorSetInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkDescriptorUpdateTemplate descriptorUpdateTemplate ;VkPipelineLayout layout ;uint32_t set ;void* pData ;} VkPushDescriptorSetWithTemplateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkShaderStageFlags stageFlags ;VkPipelineLayout layout ;uint32_t firstSet ;uint32_t setCount ;uint32_t* pBufferIndices ;void* pOffsets ;} VkSetDescriptorBufferOffsetsInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkShaderStageFlags stageFlags ;VkPipelineLayout layout ;uint32_t set ;} VkBindDescriptorBufferEmbeddedSamplersInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t perStageDescriptorSet ;uint32_t dynamicPipelineLayout ;} VkPhysicalDevicePerStageDescriptorSetFeaturesNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t timingCount ;void* pTimings ;} VkGetLatencyMarkerInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t renderPassStriped ;} VkPhysicalDeviceRenderPassStripedFeaturesARM;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkExtent2D renderPassStripeGranularity ;uint32_t maxRenderPassStripes ;} VkPhysicalDeviceRenderPassStripedPropertiesARM;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkRect2D stripeArea ;} VkRenderPassStripeInfoARM;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t stripeInfoCount ;VkRenderPassStripeInfoARM* pStripeInfos ;} VkRenderPassStripeBeginInfoARM;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t stripeSemaphoreInfoCount ;VkSemaphoreSubmitInfo* pStripeSemaphoreInfos ;} VkRenderPassStripeSubmitInfoARM;';
    }
    ...
    public function addExtension(string $extension): void
    {
        ...
        if($extension === 'VK_KHR_calibrated_timestamps') $this->cdefs[] = 'VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsKHR(VkPhysicalDevice physicalDevice,uint32_t* pTimeDomainCount,void* pTimeDomains);';
        if($extension === 'VK_KHR_calibrated_timestamps') $this->cdefs[] = 'VkResult vkGetCalibratedTimestampsKHR(VkDevice device,uint32_t timestampCount,VkCalibratedTimestampInfoKHR* pTimestampInfos,uint64_t* pTimestamps,uint64_t* pMaxDeviation);';
        ...
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdBindDescriptorSets2KHR(VkCommandBuffer commandBuffer,VkBindDescriptorSetsInfoKHR* pBindDescriptorSetsInfo);';
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdPushConstants2KHR(VkCommandBuffer commandBuffer,VkPushConstantsInfoKHR* pPushConstantsInfo);';
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdPushDescriptorSet2KHR(VkCommandBuffer commandBuffer,VkPushDescriptorSetInfoKHR* pPushDescriptorSetInfo);';
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdPushDescriptorSetWithTemplate2KHR(VkCommandBuffer commandBuffer,VkPushDescriptorSetWithTemplateInfoKHR* pPushDescriptorSetWithTemplateInfo);';
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdSetDescriptorBufferOffsets2EXT(VkCommandBuffer commandBuffer,VkSetDescriptorBufferOffsetsInfoEXT* pSetDescriptorBufferOffsetsInfo);';
        if($extension === 'VK_KHR_maintenance6') $this->cdefs[] = 'void vkCmdBindDescriptorBufferEmbeddedSamplers2EXT(VkCommandBuffer commandBuffer,VkBindDescriptorBufferEmbeddedSamplersInfoEXT* pBindDescriptorBufferEmbeddedSamplersInfo);';
        ...
        if($extension === 'VK_NV_low_latency2') $this->cdefs[] = 'void vkGetLatencyTimingsNV(VkDevice device,VkSwapchainKHR swapchain,VkGetLatencyMarkerInfoNV* pLatencyMarkerInfo);';
