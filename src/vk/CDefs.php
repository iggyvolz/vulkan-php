...
final class CDefs implements \Stringable
{
    ...
    public function __construct()
    {
        ...
        $this->cdefs[] = 'typedef int VkPrivateDataSlotCreateFlagBitsEXT;';
        $this->cdefs[] = 'typedef int VkDescriptorUpdateTemplateType;';
        $this->cdefs[] = 'typedef int VkDescriptorUpdateTemplateTypeKHR;';
        ...
        $this->cdefs[] = 'typedef int VkPointClippingBehaviorKHR;';
        ...
        $this->cdefs[] = 'typedef int VkQueueGlobalPriorityEXT;';
        ...
        $this->cdefs[] = 'typedef int VkCopyAccelerationStructureModeNV;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureTypeKHR;';
        $this->cdefs[] = 'typedef int VkAccelerationStructureTypeNV;';
        $this->cdefs[] = 'typedef int VkGeometryTypeKHR;';
        $this->cdefs[] = 'typedef int VkGeometryTypeNV;';
        $this->cdefs[] = 'typedef int VkRayTracingShaderGroupTypeKHR;';
        $this->cdefs[] = 'typedef int VkRayTracingShaderGroupTypeNV;';
        ...
        $this->cdefs[] = 'typedef int VkPipelineCreationFeedbackFlagBitsEXT;';
        ...
        $this->cdefs[] = 'typedef int VkSemaphoreWaitFlagBitsKHR;';
        ...
        $this->cdefs[] = 'typedef int VkToolPurposeFlagBitsEXT;';
        ...
        $this->cdefs[] = 'typedef int VkAccessFlagBits2KHR;';
        $this->cdefs[] = 'typedef int VkPipelineStageFlagBits2;';
        $this->cdefs[] = 'typedef int VkPipelineStageFlagBits2KHR;';
        ...
        $this->cdefs[] = 'typedef int VkFormatFeatureFlagBits2KHR;';
        $this->cdefs[] = 'typedef int VkRenderingFlagBits;';
        $this->cdefs[] = 'typedef int VkRenderingFlagBitsKHR;';
        ...
        $this->cdefs[] = 'typedef int VkScopeNV;';
        $this->cdefs[] = 'typedef int VkComponentTypeNV;';
        ...
        $this->cdefs[] = 'typedef int VkExternalMemoryHandleTypeFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkExternalMemoryFeatureFlagBits;';
        $this->cdefs[] = 'typedef int VkExternalMemoryFeatureFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreHandleTypeFlagBits;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreHandleTypeFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreFeatureFlagBits;';
        $this->cdefs[] = 'typedef int VkExternalSemaphoreFeatureFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkSemaphoreImportFlagBits;';
        $this->cdefs[] = 'typedef int VkSemaphoreImportFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkExternalFenceHandleTypeFlagBits;';
        $this->cdefs[] = 'typedef int VkExternalFenceHandleTypeFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkExternalFenceFeatureFlagBits;';
        $this->cdefs[] = 'typedef int VkExternalFenceFeatureFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkFenceImportFlagBits;';
        $this->cdefs[] = 'typedef int VkFenceImportFlagBitsKHR;';
        ...
        $this->cdefs[] = 'typedef int VkPeerMemoryFeatureFlagBitsKHR;';
        $this->cdefs[] = 'typedef int VkMemoryAllocateFlagBits;';
        $this->cdefs[] = 'typedef int VkMemoryAllocateFlagBitsKHR;';
        ...
        $this->cdefs[] = 'typedef int VkTessellationDomainOriginKHR;';
        $this->cdefs[] = 'typedef int VkSamplerYcbcrModelConversion;';
        $this->cdefs[] = 'typedef int VkSamplerYcbcrModelConversionKHR;';
        $this->cdefs[] = 'typedef int VkSamplerYcbcrRange;';
        $this->cdefs[] = 'typedef int VkSamplerYcbcrRangeKHR;';
        $this->cdefs[] = 'typedef int VkChromaLocation;';
        $this->cdefs[] = 'typedef int VkChromaLocationKHR;';
        $this->cdefs[] = 'typedef int VkSamplerReductionMode;';
        $this->cdefs[] = 'typedef int VkSamplerReductionModeEXT;';
        ...
        $this->cdefs[] = 'typedef int VkShaderFloatControlsIndependenceKHR;';
        ...
        $this->cdefs[] = 'typedef int VkSubmitFlagBitsKHR;';
        ...
        $this->cdefs[] = 'typedef int VkDriverIdKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t queueFamilyIndex ;uint32_t queueCount ;void* pQueuePriorities ;} VkDeviceQueueCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t queueCreateInfoCount ;VkDeviceQueueCreateInfo* pQueueCreateInfos ;uint32_t enabledLayerCount ;void* ppEnabledLayerNames ;uint32_t enabledExtensionCount ;void* ppEnabledExtensionNames ;void* pEnabledFeatures ;} VkDeviceCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkApplicationInfo* pApplicationInfo ;uint32_t enabledLayerCount ;void* ppEnabledLayerNames ;uint32_t enabledExtensionCount ;void* ppEnabledExtensionNames ;} VkInstanceCreateInfo;';
        $this->cdefs[] = 'typedef struct {void* queueFlags ;uint32_t queueCount ;uint32_t timestampValidBits ;VkExtent3D minImageTransferGranularity ;} VkQueueFamilyProperties;';
        ...
        $this->cdefs[] = 'typedef struct {void* aspectMask ;VkExtent3D imageGranularity ;void* flags ;} VkSparseImageFormatProperties;';
        ...
        $this->cdefs[] = 'typedef struct {void* propertyFlags ;uint32_t heapIndex ;} VkMemoryType;';
        $this->cdefs[] = 'typedef struct {uint64_t size ;void* flags ;} VkMemoryHeap;';
        ...
        $this->cdefs[] = 'typedef struct {void* linearTilingFeatures ;void* optimalTilingFeatures ;void* bufferFeatures ;} VkFormatProperties;';
        $this->cdefs[] = 'typedef struct {VkExtent3D maxExtent ;uint32_t maxMipLevels ;uint32_t maxArrayLayers ;void* sampleCounts ;uint64_t maxResourceSize ;} VkImageFormatProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* usage ;} VkBufferUsageFlags2CreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint64_t size ;void* usage ;VkSharingMode sharingMode ;uint32_t queueFamilyIndexCount ;uint32_t* pQueueFamilyIndices ;} VkBufferCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkBuffer buffer ;VkFormat format ;uint64_t offset ;uint64_t range ;} VkBufferViewCreateInfo;';
        $this->cdefs[] = 'typedef struct {void* aspectMask ;uint32_t mipLevel ;uint32_t arrayLayer ;} VkImageSubresource;';
        $this->cdefs[] = 'typedef struct {void* aspectMask ;uint32_t mipLevel ;uint32_t baseArrayLayer ;uint32_t layerCount ;} VkImageSubresourceLayers;';
        $this->cdefs[] = 'typedef struct {void* aspectMask ;uint32_t baseMipLevel ;uint32_t levelCount ;uint32_t baseArrayLayer ;uint32_t layerCount ;} VkImageSubresourceRange;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcAccessMask ;void* dstAccessMask ;} VkMemoryBarrier;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcAccessMask ;void* dstAccessMask ;uint32_t srcQueueFamilyIndex ;uint32_t dstQueueFamilyIndex ;VkBuffer buffer ;uint64_t offset ;uint64_t size ;} VkBufferMemoryBarrier;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcAccessMask ;void* dstAccessMask ;VkImageLayout oldLayout ;VkImageLayout newLayout ;uint32_t srcQueueFamilyIndex ;uint32_t dstQueueFamilyIndex ;VkImage image ;VkImageSubresourceRange subresourceRange ;} VkImageMemoryBarrier;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkImageType imageType ;VkFormat format ;VkExtent3D extent ;uint32_t mipLevels ;uint32_t arrayLayers ;VkSampleCountFlagBits samples ;VkImageTiling tiling ;void* usage ;VkSharingMode sharingMode ;uint32_t queueFamilyIndexCount ;uint32_t* pQueueFamilyIndices ;VkImageLayout initialLayout ;} VkImageCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkImage image ;VkImageViewType viewType ;VkFormat format ;VkComponentMapping components ;VkImageSubresourceRange subresourceRange ;} VkImageViewCreateInfo;';
        $this->cdefs[] = 'typedef struct {uint64_t srcOffset ;uint64_t dstOffset ;uint64_t size ;} VkBufferCopy;';
        $this->cdefs[] = 'typedef struct {uint64_t resourceOffset ;uint64_t size ;VkDeviceMemory memory ;uint64_t memoryOffset ;void* flags ;} VkSparseMemoryBind;';
        $this->cdefs[] = 'typedef struct {VkImageSubresource subresource ;VkOffset3D offset ;VkExtent3D extent ;VkDeviceMemory memory ;uint64_t memoryOffset ;void* flags ;} VkSparseImageMemoryBind;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;size_t codeSize ;uint32_t* pCode ;} VkShaderModuleCreateInfo;';
        $this->cdefs[] = 'typedef struct {uint32_t binding ;VkDescriptorType descriptorType ;uint32_t descriptorCount ;void* stageFlags ;VkSampler* pImmutableSamplers ;} VkDescriptorSetLayoutBinding;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t bindingCount ;VkDescriptorSetLayoutBinding* pBindings ;} VkDescriptorSetLayoutCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkDescriptorType type ;uint32_t descriptorCount ;} VkDescriptorPoolSize;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t maxSets ;uint32_t poolSizeCount ;VkDescriptorPoolSize* pPoolSizes ;} VkDescriptorPoolCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkShaderStageFlagBits stage ;VkShaderModule module ;const char* pName ;VkSpecializationInfo* pSpecializationInfo ;} VkPipelineShaderStageCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkPipelineShaderStageCreateInfo stage ;VkPipelineLayout layout ;VkPipeline basePipelineHandle ;int32_t basePipelineIndex ;} VkComputePipelineCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkPipelineCreateFlags2CreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkPrimitiveTopology topology ;uint32_t primitiveRestartEnable ;} VkPipelineInputAssemblyStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t patchControlPoints ;} VkPipelineTessellationStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t viewportCount ;VkViewport* pViewports ;uint32_t scissorCount ;VkRect2D* pScissors ;} VkPipelineViewportStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t depthClampEnable ;uint32_t rasterizerDiscardEnable ;VkPolygonMode polygonMode ;void* cullMode ;VkFrontFace frontFace ;uint32_t depthBiasEnable ;float depthBiasConstantFactor ;float depthBiasClamp ;float depthBiasSlopeFactor ;float lineWidth ;} VkPipelineRasterizationStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkSampleCountFlagBits rasterizationSamples ;uint32_t sampleShadingEnable ;float minSampleShading ;void* pSampleMask ;uint32_t alphaToCoverageEnable ;uint32_t alphaToOneEnable ;} VkPipelineMultisampleStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {uint32_t blendEnable ;VkBlendFactor srcColorBlendFactor ;VkBlendFactor dstColorBlendFactor ;VkBlendOp colorBlendOp ;VkBlendFactor srcAlphaBlendFactor ;VkBlendFactor dstAlphaBlendFactor ;VkBlendOp alphaBlendOp ;void* colorWriteMask ;} VkPipelineColorBlendAttachmentState;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t logicOpEnable ;VkLogicOp logicOp ;uint32_t attachmentCount ;VkPipelineColorBlendAttachmentState* pAttachments ;float blendConstants [4];} VkPipelineColorBlendStateCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t dynamicStateCount ;void* pDynamicStates ;} VkPipelineDynamicStateCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t depthTestEnable ;uint32_t depthWriteEnable ;VkCompareOp depthCompareOp ;uint32_t depthBoundsTestEnable ;uint32_t stencilTestEnable ;VkStencilOpState front ;VkStencilOpState back ;float minDepthBounds ;float maxDepthBounds ;} VkPipelineDepthStencilStateCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;size_t initialDataSize ;void* pInitialData ;} VkPipelineCacheCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {void* stageFlags ;uint32_t offset ;uint32_t size ;} VkPushConstantRange;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t setLayoutCount ;VkDescriptorSetLayout* pSetLayouts ;uint32_t pushConstantRangeCount ;VkPushConstantRange* pPushConstantRanges ;} VkPipelineLayoutCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkFilter magFilter ;VkFilter minFilter ;VkSamplerMipmapMode mipmapMode ;VkSamplerAddressMode addressModeU ;VkSamplerAddressMode addressModeV ;VkSamplerAddressMode addressModeW ;float mipLodBias ;uint32_t anisotropyEnable ;float maxAnisotropy ;uint32_t compareEnable ;VkCompareOp compareOp ;float minLod ;float maxLod ;VkBorderColor borderColor ;uint32_t unnormalizedCoordinates ;} VkSamplerCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t queueFamilyIndex ;} VkCommandPoolCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkRenderPass renderPass ;uint32_t subpass ;VkFramebuffer framebuffer ;uint32_t occlusionQueryEnable ;void* queryFlags ;void* pipelineStatistics ;} VkCommandBufferInheritanceInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkCommandBufferInheritanceInfo* pInheritanceInfo ;} VkCommandBufferBeginInfo;';
        ...
        $this->cdefs[] = 'typedef struct {void* aspectMask ;uint32_t colorAttachment ;void* clearValue ;} VkClearAttachment;';
        $this->cdefs[] = 'typedef struct {void* flags ;VkFormat format ;VkSampleCountFlagBits samples ;VkAttachmentLoadOp loadOp ;VkAttachmentStoreOp storeOp ;VkAttachmentLoadOp stencilLoadOp ;VkAttachmentStoreOp stencilStoreOp ;VkImageLayout initialLayout ;VkImageLayout finalLayout ;} VkAttachmentDescription;';
        $this->cdefs[] = 'typedef struct {uint32_t attachment ;VkImageLayout layout ;} VkAttachmentReference;';
        $this->cdefs[] = 'typedef struct {void* flags ;VkPipelineBindPoint pipelineBindPoint ;uint32_t inputAttachmentCount ;VkAttachmentReference* pInputAttachments ;uint32_t colorAttachmentCount ;VkAttachmentReference* pColorAttachments ;VkAttachmentReference* pResolveAttachments ;VkAttachmentReference* pDepthStencilAttachment ;uint32_t preserveAttachmentCount ;uint32_t* pPreserveAttachments ;} VkSubpassDescription;';
        $this->cdefs[] = 'typedef struct {uint32_t srcSubpass ;uint32_t dstSubpass ;void* srcStageMask ;void* dstStageMask ;void* srcAccessMask ;void* dstAccessMask ;void* dependencyFlags ;} VkSubpassDependency;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t attachmentCount ;VkAttachmentDescription* pAttachments ;uint32_t subpassCount ;VkSubpassDescription* pSubpasses ;uint32_t dependencyCount ;VkSubpassDependency* pDependencies ;} VkRenderPassCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkEventCreateInfo;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkFenceCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkDisplayKHR display ;const char* displayName ;VkExtent2D physicalDimensions ;VkExtent2D physicalResolution ;void* supportedTransforms ;uint32_t planeReorderPossible ;uint32_t persistentContent ;} VkDisplayPropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDisplayModeParametersKHR parameters ;} VkDisplayModeCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {void* supportedAlpha ;VkOffset2D minSrcPosition ;VkOffset2D maxSrcPosition ;VkExtent2D minSrcExtent ;VkExtent2D maxSrcExtent ;VkOffset2D minDstPosition ;VkOffset2D maxDstPosition ;VkExtent2D minDstExtent ;VkExtent2D maxDstExtent ;} VkDisplayPlaneCapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDisplayModeKHR displayMode ;uint32_t planeIndex ;uint32_t planeStackIndex ;VkSurfaceTransformFlagBitsKHR transform ;float globalAlpha ;VkDisplayPlaneAlphaFlagBitsKHR alphaMode ;VkExtent2D imageExtent ;} VkDisplaySurfaceCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {uint32_t minImageCount ;uint32_t maxImageCount ;VkExtent2D currentExtent ;VkExtent2D minImageExtent ;VkExtent2D maxImageExtent ;uint32_t maxImageArrayLayers ;void* supportedTransforms ;VkSurfaceTransformFlagBitsKHR currentTransform ;void* supportedCompositeAlpha ;void* supportedUsageFlags ;} VkSurfaceCapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* window ;} VkAndroidSurfaceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* window ;} VkViSurfaceCreateInfoNN;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* display ;void* surface ;} VkWaylandSurfaceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* hinstance ;void* hwnd ;} VkWin32SurfaceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* dpy ;void* window ;} VkXlibSurfaceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* connection ;uint32_t window ;} VkXcbSurfaceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* dfb ;void* surface ;} VkDirectFBSurfaceCreateInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t imagePipeHandle ;} VkImagePipeSurfaceCreateInfoFUCHSIA;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* streamDescriptor ;} VkStreamDescriptorSurfaceCreateInfoGGP;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* context ;void* window ;} VkScreenSurfaceCreateInfoQNX;';
        $this->cdefs[] = 'typedef struct {VkFormat format ;VkColorSpaceKHR colorSpace ;} VkSurfaceFormatKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkSurfaceKHR surface ;uint32_t minImageCount ;VkFormat imageFormat ;VkColorSpaceKHR imageColorSpace ;VkExtent2D imageExtent ;uint32_t imageArrayLayers ;void* imageUsage ;VkSharingMode imageSharingMode ;uint32_t queueFamilyIndexCount ;uint32_t* pQueueFamilyIndices ;VkSurfaceTransformFlagBitsKHR preTransform ;VkCompositeAlphaFlagBitsKHR compositeAlpha ;VkPresentModeKHR presentMode ;uint32_t clipped ;VkSwapchainKHR oldSwapchain ;} VkSwapchainCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pfnCallback ;void* pUserData ;} VkDebugReportCallbackCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkImageFormatProperties imageFormatProperties ;void* externalMemoryFeatures ;void* exportFromImportedHandleTypes ;void* compatibleHandleTypes ;} VkExternalImageFormatPropertiesNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExternalMemoryImageCreateInfoNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExportMemoryAllocateInfoNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleType ;void* handle ;} VkImportMemoryWin32HandleInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkPrivateDataSlotCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkIndirectCommandsTokenTypeNV tokenType ;uint32_t stream ;uint32_t offset ;uint32_t vertexBindingUnit ;uint32_t vertexDynamicStride ;VkPipelineLayout pushconstantPipelineLayout ;void* pushconstantShaderStageFlags ;uint32_t pushconstantOffset ;uint32_t pushconstantSize ;void* indirectStateFlags ;uint32_t indexTypeCount ;void* pIndexTypes ;uint32_t* pIndexTypeValues ;} VkIndirectCommandsLayoutTokenNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkPipelineBindPoint pipelineBindPoint ;uint32_t tokenCount ;VkIndirectCommandsLayoutTokenNV* pTokens ;uint32_t streamCount ;uint32_t* pStreamStrides ;} VkIndirectCommandsLayoutCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;VkImageType type ;VkImageTiling tiling ;void* usage ;void* flags ;} VkPhysicalDeviceImageFormatInfo2;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;VkImageType type ;VkSampleCountFlagBits samples ;void* usage ;VkImageTiling tiling ;} VkPhysicalDeviceSparseImageFormatInfo2;';
        ...
        $this->cdefs[] = 'typedef struct {void* externalMemoryFeatures ;void* exportFromImportedHandleTypes ;void* compatibleHandleTypes ;} VkExternalMemoryProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* usage ;VkExternalMemoryHandleTypeFlagBits handleType ;} VkPhysicalDeviceExternalBufferInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExternalMemoryImageCreateInfo;';
        $this->cdefs[] = 'typedef struct {} VkExternalMemoryImageCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExternalMemoryBufferCreateInfo;';
        $this->cdefs[] = 'typedef struct {} VkExternalMemoryBufferCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExportMemoryAllocateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* exportFromImportedHandleTypes ;void* compatibleHandleTypes ;void* externalSemaphoreFeatures ;} VkExternalSemaphoreProperties;';
        $this->cdefs[] = 'typedef struct {} VkExternalSemaphorePropertiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExportSemaphoreCreateInfo;';
        $this->cdefs[] = 'typedef struct {} VkExportSemaphoreCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkSemaphore semaphore ;void* flags ;VkExternalSemaphoreHandleTypeFlagBits handleType ;void* handle ;void* name ;} VkImportSemaphoreWin32HandleInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkSemaphore semaphore ;void* flags ;VkExternalSemaphoreHandleTypeFlagBits handleType ;int16_t fd ;} VkImportSemaphoreFdInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkSemaphore semaphore ;void* flags ;VkExternalSemaphoreHandleTypeFlagBits handleType ;uint32_t zirconHandle ;} VkImportSemaphoreZirconHandleInfoFUCHSIA;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* exportFromImportedHandleTypes ;void* compatibleHandleTypes ;void* externalFenceFeatures ;} VkExternalFenceProperties;';
        $this->cdefs[] = 'typedef struct {} VkExternalFencePropertiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* handleTypes ;} VkExportFenceCreateInfo;';
        $this->cdefs[] = 'typedef struct {} VkExportFenceCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFence fence ;void* flags ;VkExternalFenceHandleTypeFlagBits handleType ;void* handle ;void* name ;} VkImportFenceWin32HandleInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFence fence ;void* flags ;VkExternalFenceHandleTypeFlagBits handleType ;int16_t fd ;} VkImportFenceFdInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t minImageCount ;uint32_t maxImageCount ;VkExtent2D currentExtent ;VkExtent2D minImageExtent ;VkExtent2D maxImageExtent ;uint32_t maxImageArrayLayers ;void* supportedTransforms ;VkSurfaceTransformFlagBitsKHR currentTransform ;void* supportedCompositeAlpha ;void* supportedUsageFlags ;void* supportedSurfaceCounters ;} VkSurfaceCapabilities2EXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* surfaceCounters ;} VkSwapchainCounterCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t deviceMask ;} VkMemoryAllocateFlagsInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* presentMask ;void* modes ;} VkDeviceGroupPresentCapabilitiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* modes ;} VkDeviceGroupSwapchainCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pView ;} VkIOSSurfaceCreateInfoMVK;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pView ;} VkMacOSSurfaceCreateInfoMVK;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pLayer ;} VkMetalSurfaceCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t viewportCount ;VkViewportSwizzleNV* pViewportSwizzles ;} VkPipelineViewportSwizzleStateCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDiscardRectangleModeEXT discardRectangleMode ;uint32_t discardRectangleCount ;VkRect2D* pDiscardRectangles ;} VkPipelineDiscardRectangleStateCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {uint32_t subpass ;uint32_t inputAttachmentIndex ;void* aspectMask ;} VkInputAttachmentAspectReference;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* sharedPresentSupportedUsageFlags ;} VkSharedPresentSurfaceCapabilitiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t subgroupSize ;void* supportedStages ;void* supportedOperations ;uint32_t quadOperationsInAllStages ;} VkPhysicalDeviceSubgroupProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* usage ;} VkImageViewUsageCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkBuffer buffer ;uint64_t offset ;void* flags ;} VkConditionalRenderingBeginInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t queueFamilyIndex ;uint32_t queueIndex ;} VkDeviceQueueInfo2;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t coverageToColorEnable ;uint32_t coverageToColorLocation ;} VkPipelineCoverageToColorStateCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* sampleLocationSampleCounts ;VkExtent2D maxSampleLocationGridSize ;void* sampleLocationCoordinateRange ;uint32_t sampleLocationSubPixelBits ;uint32_t variableSampleLocations ;} VkPhysicalDeviceSampleLocationsPropertiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkCoverageModulationModeNV coverageModulationMode ;uint32_t coverageModulationTableEnable ;uint32_t coverageModulationTableCount ;void* pCoverageModulationTable ;} VkPipelineCoverageModulationStateCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;size_t initialDataSize ;void* pInitialData ;} VkValidationCacheCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* usage ;} VkSwapchainImageCreateInfoANDROID;';
        ...
        $this->cdefs[] = 'typedef struct {void* shaderStageMask ;VkShaderResourceUsageAMD resourceUsage ;uint32_t numPhysicalVgprs ;uint32_t numPhysicalSgprs ;uint32_t numAvailableVgprs ;uint32_t numAvailableSgprs ;void* computeWorkGroupSize ;} VkShaderStatisticsInfoAMD;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* messageSeverity ;void* messageType ;void* pfnUserCallback ;void* pUserData ;} VkDebugUtilsMessengerCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pfnUserCallback ;void* pUserData ;} VkDeviceDeviceMemoryReportCreateInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDeviceMemoryReportEventTypeEXT type ;uint64_t memoryObjectId ;uint64_t size ;VkObjectType objectType ;uint64_t objectHandle ;uint32_t heapIndex ;} VkDeviceMemoryReportCallbackDataEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* shaderCoreFeatures ;uint32_t activeComputeUnitCount ;} VkPhysicalDeviceShaderCoreProperties2AMD;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkConservativeRasterizationModeEXT conservativeRasterizationMode ;float extraPrimitiveOverestimationSize ;} VkPipelineRasterizationConservativeStateCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t attachment ;VkImageLayout layout ;void* aspectMask ;} VkAttachmentReference2;';
        $this->cdefs[] = 'typedef struct {} VkAttachmentReference2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkPipelineBindPoint pipelineBindPoint ;uint32_t viewMask ;uint32_t inputAttachmentCount ;VkAttachmentReference2* pInputAttachments ;uint32_t colorAttachmentCount ;VkAttachmentReference2* pColorAttachments ;VkAttachmentReference2* pResolveAttachments ;VkAttachmentReference2* pDepthStencilAttachment ;uint32_t preserveAttachmentCount ;uint32_t* pPreserveAttachments ;} VkSubpassDescription2;';
        $this->cdefs[] = 'typedef struct {} VkSubpassDescription2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t srcSubpass ;uint32_t dstSubpass ;void* srcStageMask ;void* dstStageMask ;void* srcAccessMask ;void* dstAccessMask ;void* dependencyFlags ;int32_t viewOffset ;} VkSubpassDependency2;';
        $this->cdefs[] = 'typedef struct {} VkSubpassDependency2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t attachmentCount ;VkAttachmentDescription2* pAttachments ;uint32_t subpassCount ;VkSubpassDescription2* pSubpasses ;uint32_t dependencyCount ;VkSubpassDependency2* pDependencies ;uint32_t correlatedViewMaskCount ;uint32_t* pCorrelatedViewMasks ;} VkRenderPassCreateInfo2;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t semaphoreCount ;VkSemaphore* pSemaphores ;uint64_t* pValues ;} VkSemaphoreWaitInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;uint64_t externalFormat ;void* formatFeatures ;VkComponentMapping samplerYcbcrConversionComponents ;VkSamplerYcbcrModelConversion suggestedYcbcrModel ;VkSamplerYcbcrRange suggestedYcbcrRange ;VkChromaLocation suggestedXChromaOffset ;VkChromaLocation suggestedYChromaOffset ;} VkAndroidHardwareBufferFormatPropertiesANDROID;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* checkpointExecutionStageMask ;} VkQueueFamilyCheckpointPropertiesNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* supportedDepthResolveModes ;void* supportedStencilResolveModes ;uint32_t independentResolveNone ;uint32_t independentResolve ;} VkPhysicalDeviceDepthStencilResolveProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t rasterizationStream ;} VkPipelineRasterizationStateStreamCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* supportedQueues ;} VkPhysicalDeviceCopyMemoryIndirectPropertiesNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* decompressionMethods ;uint64_t maxDecompressionIndirectCount ;} VkPhysicalDeviceMemoryDecompressionPropertiesNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkGeometryTypeKHR geometryType ;VkGeometryDataNV geometry ;void* flags ;} VkGeometryNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkAccelerationStructureTypeNV type ;void* flags ;uint32_t instanceCount ;uint32_t geometryCount ;VkGeometryNV* pGeometries ;} VkAccelerationStructureInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {uint64_t drmFormatModifier ;uint32_t drmFormatModifierPlaneCount ;void* drmFormatModifierTilingFeatures ;} VkDrmFormatModifierPropertiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* stencilUsage ;} VkImageStencilUsageCreateInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t depthClipEnable ;} VkPipelineRasterizationDepthClipStateCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* usage ;uint32_t width ;uint32_t height ;uint32_t layerCount ;uint32_t viewFormatCount ;void* pViewFormats ;} VkFramebufferAttachmentImageInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* cooperativeMatrixSupportedStages ;} VkPhysicalDeviceCooperativeMatrixPropertiesNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t MSize ;uint32_t NSize ;uint32_t KSize ;VkComponentTypeNV AType ;VkComponentTypeNV BType ;VkComponentTypeNV CType ;VkComponentTypeNV DType ;VkScopeNV scope ;} VkCooperativeMatrixPropertiesNV;';
        ...
        $this->cdefs[] = 'typedef struct {void* flags ;uint64_t duration ;} VkPipelineCreationFeedback;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;char name [256];char category [256];char description [256];} VkPerformanceCounterDescriptionKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint64_t timeout ;} VkAcquireProfilingLockInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkHeadlessSurfaceCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkCoverageReductionModeNV coverageReductionMode ;} VkPipelineCoverageReductionStateCreateInfoNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkCoverageReductionModeNV coverageReductionMode ;VkSampleCountFlagBits rasterizationSamples ;void* depthStencilSamples ;void* colorSamples ;} VkFramebufferMixedSamplesCombinationNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* stages ;char name [256];char description [256];uint32_t subgroupSize ;} VkPipelineExecutablePropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t minSubgroupSize ;uint32_t maxSubgroupSize ;uint32_t maxComputeWorkgroupSubgroups ;void* requiredSubgroupSizeStages ;} VkPhysicalDeviceSubgroupSizeControlProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint8_t deviceUUID [16];uint8_t driverUUID [16];void* deviceLUID ;uint32_t deviceNodeMask ;uint32_t deviceLUIDValid ;uint32_t subgroupSize ;void* subgroupSupportedStages ;void* subgroupSupportedOperations ;uint32_t subgroupQuadOperationsInAllStages ;VkPointClippingBehavior pointClippingBehavior ;uint32_t maxMultiviewViewCount ;uint32_t maxMultiviewInstanceIndex ;uint32_t protectedNoFault ;uint32_t maxPerSetDescriptors ;uint64_t maxMemoryAllocationSize ;} VkPhysicalDeviceVulkan11Properties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;char name [256];char version [256];void* purposes ;char description [256];char layer [256];} VkPhysicalDeviceToolProperties;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkGeometryTypeKHR geometryType ;void* geometry ;void* flags ;} VkAccelerationStructureGeometryKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkAccelerationStructureTypeKHR type ;void* flags ;VkBuildAccelerationStructureModeKHR mode ;VkAccelerationStructureKHR srcAccelerationStructure ;VkAccelerationStructureKHR dstAccelerationStructure ;uint32_t geometryCount ;VkAccelerationStructureGeometryKHR* pGeometries ;void* ppGeometries ;void* scratchData ;} VkAccelerationStructureBuildGeometryInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* createFlags ;VkBuffer buffer ;uint64_t offset ;uint64_t size ;VkAccelerationStructureTypeKHR type ;uint64_t deviceAddress ;} VkAccelerationStructureCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkObjectType objectType ;uint64_t objectHandle ;void* flags ;} VkRefreshObjectKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkDeviceDiagnosticsConfigCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* sampleCounts ;VkExtent2D fragmentSize ;} VkPhysicalDeviceFragmentShadingRateKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcStageMask ;void* srcAccessMask ;void* dstStageMask ;void* dstAccessMask ;} VkMemoryBarrier2;';
        $this->cdefs[] = 'typedef struct {} VkMemoryBarrier2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcStageMask ;void* srcAccessMask ;void* dstStageMask ;void* dstAccessMask ;VkImageLayout oldLayout ;VkImageLayout newLayout ;uint32_t srcQueueFamilyIndex ;uint32_t dstQueueFamilyIndex ;VkImage image ;VkImageSubresourceRange subresourceRange ;} VkImageMemoryBarrier2;';
        $this->cdefs[] = 'typedef struct {} VkImageMemoryBarrier2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* srcStageMask ;void* srcAccessMask ;void* dstStageMask ;void* dstAccessMask ;uint32_t srcQueueFamilyIndex ;uint32_t dstQueueFamilyIndex ;VkBuffer buffer ;uint64_t offset ;uint64_t size ;} VkBufferMemoryBarrier2;';
        $this->cdefs[] = 'typedef struct {} VkBufferMemoryBarrier2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* dependencyFlags ;uint32_t memoryBarrierCount ;VkMemoryBarrier2* pMemoryBarriers ;uint32_t bufferMemoryBarrierCount ;VkBufferMemoryBarrier2* pBufferMemoryBarriers ;uint32_t imageMemoryBarrierCount ;VkImageMemoryBarrier2* pImageMemoryBarriers ;} VkDependencyInfo;';
        $this->cdefs[] = 'typedef struct {} VkDependencyInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkSemaphore semaphore ;uint64_t value ;void* stageMask ;uint32_t deviceIndex ;} VkSemaphoreSubmitInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t waitSemaphoreInfoCount ;VkSemaphoreSubmitInfo* pWaitSemaphoreInfos ;uint32_t commandBufferInfoCount ;VkCommandBufferSubmitInfo* pCommandBufferInfos ;uint32_t signalSemaphoreInfoCount ;VkSemaphoreSubmitInfo* pSignalSemaphoreInfos ;} VkSubmitInfo2;';
        $this->cdefs[] = 'typedef struct {} VkSubmitInfo2KHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* checkpointExecutionStageMask ;} VkQueueFamilyCheckpointProperties2NV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* stage ;void* pCheckpointMarker ;} VkCheckpointData2NV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkImage dstImage ;VkImageLayout dstImageLayout ;uint32_t regionCount ;VkMemoryToImageCopyEXT* pRegions ;} VkCopyMemoryToImageInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkImage srcImage ;VkImageLayout srcImageLayout ;uint32_t regionCount ;VkImageToMemoryCopyEXT* pRegions ;} VkCopyImageToMemoryInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkImage srcImage ;VkImageLayout srcImageLayout ;VkImage dstImage ;VkImageLayout dstImageLayout ;uint32_t regionCount ;VkImageCopy2* pRegions ;} VkCopyImageToImageInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* videoCodecOperations ;} VkQueueFamilyVideoPropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* imageUsage ;} VkPhysicalDeviceVideoFormatInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;VkComponentMapping componentMapping ;void* imageCreateFlags ;VkImageType imageType ;VkImageTiling imageTiling ;void* imageUsageFlags ;} VkVideoFormatPropertiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkVideoCodecOperationFlagBitsKHR videoCodecOperation ;void* chromaSubsampling ;void* lumaBitDepth ;void* chromaBitDepth ;} VkVideoProfileInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint64_t minBitstreamBufferOffsetAlignment ;uint64_t minBitstreamBufferSizeAlignment ;VkExtent2D pictureAccessGranularity ;VkExtent2D minCodedExtent ;VkExtent2D maxCodedExtent ;uint32_t maxDpbSlots ;uint32_t maxActiveReferencePictures ;VkExtensionProperties stdHeaderVersion ;} VkVideoCapabilitiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkVideoDecodeCapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* videoUsageHints ;} VkVideoDecodeUsageInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkBuffer srcBuffer ;uint64_t srcBufferOffset ;uint64_t srcBufferRange ;VkVideoPictureResourceInfoKHR dstPictureResource ;VkVideoReferenceSlotInfoKHR* pSetupReferenceSlot ;uint32_t referenceSlotCount ;VkVideoReferenceSlotInfoKHR* pReferenceSlots ;} VkVideoDecodeInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t queueFamilyIndex ;void* flags ;void* pVideoProfile ;VkFormat pictureFormat ;VkExtent2D maxCodedExtent ;VkFormat referencePictureFormat ;uint32_t maxDpbSlots ;uint32_t maxActiveReferencePictures ;VkExtensionProperties* pStdHeaderVersion ;} VkVideoSessionCreateInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkVideoSessionParametersKHR videoSessionParametersTemplate ;VkVideoSessionKHR videoSession ;} VkVideoSessionParametersCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkVideoSessionKHR videoSession ;VkVideoSessionParametersKHR videoSessionParameters ;uint32_t referenceSlotCount ;VkVideoReferenceSlotInfoKHR* pReferenceSlots ;} VkVideoBeginCodingInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkVideoEndCodingInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkVideoCodingControlInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* videoUsageHints ;void* videoContentHints ;VkVideoEncodeTuningModeKHR tuningMode ;} VkVideoEncodeUsageInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkBuffer dstBuffer ;uint64_t dstBufferOffset ;uint64_t dstBufferRange ;VkVideoPictureResourceInfoKHR srcPictureResource ;VkVideoReferenceSlotInfoKHR* pSetupReferenceSlot ;uint32_t referenceSlotCount ;VkVideoReferenceSlotInfoKHR* pReferenceSlots ;uint32_t precedingExternallyEncodedBytes ;} VkVideoEncodeInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* encodeFeedbackFlags ;} VkQueryPoolVideoEncodeFeedbackCreateInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkVideoEncodeRateControlModeFlagBitsKHR rateControlMode ;uint32_t layerCount ;void* pLayers ;uint32_t virtualBufferSizeInMs ;uint32_t initialVirtualBufferSizeInMs ;} VkVideoEncodeRateControlInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* rateControlModes ;uint32_t maxRateControlLayers ;uint64_t maxBitrate ;uint32_t maxQualityLevels ;VkExtent2D encodeInputPictureGranularity ;void* supportedEncodeFeedbackFlags ;} VkVideoEncodeCapabilitiesKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* maxLevelIdc ;uint32_t maxSliceCount ;uint32_t maxPPictureL0ReferenceCount ;uint32_t maxBPictureL0ReferenceCount ;uint32_t maxL1ReferenceCount ;uint32_t maxTemporalLayerCount ;uint32_t expectDyadicTemporalLayerPattern ;int32_t minQp ;int32_t maxQp ;uint32_t prefersGopRemainingFrames ;uint32_t requiresGopRemainingFrames ;void* stdSyntaxFlags ;} VkVideoEncodeH264CapabilitiesEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* preferredRateControlFlags ;uint32_t preferredGopFrameCount ;uint32_t preferredIdrPeriod ;uint32_t preferredConsecutiveBFrameCount ;uint32_t preferredTemporalLayerCount ;void* preferredConstantQp ;uint32_t preferredMaxL0ReferenceCount ;uint32_t preferredMaxL1ReferenceCount ;uint32_t preferredStdEntropyCodingModeFlag ;} VkVideoEncodeH264QualityLevelPropertiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t gopFrameCount ;uint32_t idrPeriod ;uint32_t consecutiveBFrameCount ;uint32_t temporalLayerCount ;} VkVideoEncodeH264RateControlInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* maxLevelIdc ;uint32_t maxSliceSegmentCount ;VkExtent2D maxTiles ;void* ctbSizes ;void* transformBlockSizes ;uint32_t maxPPictureL0ReferenceCount ;uint32_t maxBPictureL0ReferenceCount ;uint32_t maxL1ReferenceCount ;uint32_t maxSubLayerCount ;uint32_t expectDyadicTemporalSubLayerPattern ;int32_t minQp ;int32_t maxQp ;uint32_t prefersGopRemainingFrames ;uint32_t requiresGopRemainingFrames ;void* stdSyntaxFlags ;} VkVideoEncodeH265CapabilitiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t gopFrameCount ;uint32_t idrPeriod ;uint32_t consecutiveBFrameCount ;uint32_t subLayerCount ;} VkVideoEncodeH265RateControlInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint64_t address ;void* usage ;} VkDescriptorBufferBindingInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t maxInstances ;void* flags ;} VkAccelerationStructureMotionInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkAccelerationStructureMotionInstanceTypeNV type ;void* flags ;void* data ;} VkAccelerationStructureMotionInstanceNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t memoryTypeBits ;uint32_t bufferCount ;uint32_t createInfoIndex ;uint64_t sysmemPixelFormat ;void* formatFeatures ;void* sysmemColorSpaceIndex ;VkComponentMapping samplerYcbcrConversionComponents ;VkSamplerYcbcrModelConversion suggestedYcbcrModel ;VkSamplerYcbcrRange suggestedYcbcrRange ;VkChromaLocation suggestedXChromaOffset ;VkChromaLocation suggestedYChromaOffset ;} VkBufferCollectionPropertiesFUCHSIA;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkBufferCreateInfo createInfo ;void* requiredFormatFeatures ;void* bufferCollectionConstraints ;} VkBufferConstraintsInfoFUCHSIA;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t colorSpace ;} VkSysmemColorSpaceFUCHSIA;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkImageCreateInfo imageCreateInfo ;void* requiredFormatFeatures ;void* flags ;uint64_t sysmemPixelFormat ;uint32_t colorSpaceCount ;void* pColorSpaces ;} VkImageFormatConstraintsInfoFUCHSIA;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t formatConstraintsCount ;VkImageFormatConstraintsInfoFUCHSIA* pFormatConstraints ;void* bufferCollectionConstraints ;void* flags ;} VkImageConstraintsInfoFUCHSIA;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* linearTilingFeatures ;void* optimalTilingFeatures ;void* bufferFeatures ;} VkFormatProperties3;';
        ...
        $this->cdefs[] = 'typedef struct {uint64_t drmFormatModifier ;uint32_t drmFormatModifierPlaneCount ;void* drmFormatModifierTilingFeatures ;} VkDrmFormatModifierProperties2EXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkRect2D renderArea ;uint32_t layerCount ;uint32_t viewMask ;uint32_t colorAttachmentCount ;void* pColorAttachments ;void* pDepthAttachment ;void* pStencilAttachment ;} VkRenderingInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t viewMask ;uint32_t colorAttachmentCount ;void* pColorAttachmentFormats ;VkFormat depthAttachmentFormat ;VkFormat stencilAttachmentFormat ;VkSampleCountFlagBits rasterizationSamples ;} VkCommandBufferInheritanceRenderingInfo;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;} VkGraphicsPipelineLibraryCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t compressionControlPlaneCount ;void* pFixedRateFlags ;} VkImageCompressionControlEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* imageCompressionFlags ;void* imageCompressionFixedRateFlags ;} VkImageCompressionPropertiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkMicromapTypeEXT type ;void* flags ;VkBuildMicromapModeEXT mode ;VkMicromapEXT dstMicromap ;uint32_t usageCountsCount ;void* pUsageCounts ;void* ppUsageCounts ;void* data ;void* scratchData ;void* triangleArray ;uint64_t triangleArrayStride ;} VkMicromapBuildInfoEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* createFlags ;VkBuffer buffer ;uint64_t offset ;uint64_t size ;VkMicromapTypeEXT type ;uint64_t deviceAddress ;} VkMicromapCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint64_t baseAddress ;uint64_t size ;VkDeviceAddressBindingTypeEXT bindingType ;} VkDeviceAddressBindingCallbackDataEXT;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t opticalFlow ;} VkPhysicalDeviceOpticalFlowFeaturesNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* supportedOutputGridSizes ;void* supportedHintGridSizes ;uint32_t hintSupported ;uint32_t costSupported ;uint32_t bidirectionalFlowSupported ;uint32_t globalFlowSupported ;uint32_t minWidth ;uint32_t minHeight ;uint32_t maxWidth ;uint32_t maxHeight ;uint32_t maxNumRegionsOfInterest ;} VkPhysicalDeviceOpticalFlowPropertiesNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* usage ;} VkOpticalFlowImageFormatInfoNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;} VkOpticalFlowImageFormatPropertiesNV;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;uint32_t width ;uint32_t height ;VkFormat imageFormat ;VkFormat flowVectorFormat ;VkFormat costFormat ;void* outputGridSize ;void* hintGridSize ;VkOpticalFlowPerformanceLevelNV performanceLevel ;void* flags ;} VkOpticalFlowSessionCreateInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t regionCount ;VkRect2D* pRegions ;} VkOpticalFlowExecuteInfoNV;';
        ...
        $this->cdefs[] = 'typedef struct {uint64_t srcAddress ;uint64_t dstAddress ;uint64_t compressedSize ;uint64_t decompressedSize ;void* decompressionMethod ;} VkDecompressMemoryRegionNV;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint64_t frameID ;uint32_t imageCount ;VkImage* pImages ;uint32_t bufferCount ;VkBuffer* pBuffers ;uint64_t tagName ;size_t tagSize ;void* pTag ;} VkFrameBoundaryEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* supportedPresentScaling ;void* supportedPresentGravityX ;void* supportedPresentGravityY ;VkExtent2D minScaledImageExtent ;VkExtent2D maxScaledImageExtent ;} VkSurfacePresentScalingCapabilitiesEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* scalingBehavior ;void* presentGravityX ;void* presentGravityY ;} VkSwapchainPresentScalingCreateInfoEXT;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;void* pfnGetInstanceProcAddr ;} VkDirectDriverLoadingInfoLUNARG;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDeviceMemory memory ;uint64_t offset ;uint64_t size ;} VkMemoryMapInfoKHR;';
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;VkDeviceMemory memory ;} VkMemoryUnmapInfoKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;VkFormat format ;uint64_t externalFormat ;uint64_t screenUsage ;void* formatFeatures ;VkComponentMapping samplerYcbcrConversionComponents ;VkSamplerYcbcrModelConversion suggestedYcbcrModel ;VkSamplerYcbcrRange suggestedYcbcrRange ;VkChromaLocation suggestedXChromaOffset ;VkChromaLocation suggestedYChromaOffset ;} VkScreenBufferFormatPropertiesQNX;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* cooperativeMatrixSupportedStages ;} VkPhysicalDeviceCooperativeMatrixPropertiesKHR;';
        ...
        $this->cdefs[] = 'typedef struct {VkStructureType sType ;void* pNext ;void* flags ;uint32_t stageCount ;VkPipelineShaderStageCreateInfo* pStages ;void* pLibraryInfo ;VkPipelineLayout layout ;VkPipeline basePipelineHandle ;int32_t basePipelineIndex ;} VkExecutionGraphPipelineCreateInfoAMDX;';
    ...
    public function addExtension(string $extension): void
    {
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkGetPhysicalDeviceImageFormatProperties(VkPhysicalDevice physicalDevice,VkFormat format,VkImageType type,VkImageTiling tiling,void* usage,void* flags,VkImageFormatProperties* pImageFormatProperties);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkMapMemory(VkDevice device,VkDeviceMemory memory,uint64_t offset,uint64_t size,void* flags,void* ppData);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkGetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice physicalDevice,VkFormat format,VkImageType type,VkSampleCountFlagBits samples,void* usage,VkImageTiling tiling,uint32_t* pPropertyCount,VkSparseImageFormatProperties* pProperties);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkGetQueryPoolResults(VkDevice device,VkQueryPool queryPool,uint32_t firstQuery,uint32_t queryCount,size_t dataSize,void* pData,uint64_t stride,void* flags);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkResetDescriptorPool(VkDevice device,VkDescriptorPool descriptorPool,void* flags);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkResetCommandPool(VkDevice device,VkCommandPool commandPool,void* flags);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'VkResult vkResetCommandBuffer(VkCommandBuffer commandBuffer,void* flags);';
        ...
        if($extension === 'VK_EXT_attachment_feedback_loop_dynamic_state') $this->cdefs[] = 'void vkCmdSetAttachmentFeedbackLoopEnableEXT(VkCommandBuffer commandBuffer,void* aspectMask);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdSetStencilCompareMask(VkCommandBuffer commandBuffer,void* faceMask,uint32_t compareMask);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdSetStencilWriteMask(VkCommandBuffer commandBuffer,void* faceMask,uint32_t writeMask);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdSetStencilReference(VkCommandBuffer commandBuffer,void* faceMask,uint32_t reference);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdSetEvent(VkCommandBuffer commandBuffer,VkEvent event,void* stageMask);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdResetEvent(VkCommandBuffer commandBuffer,VkEvent event,void* stageMask);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdWaitEvents(VkCommandBuffer commandBuffer,uint32_t eventCount,VkEvent* pEvents,void* srcStageMask,void* dstStageMask,uint32_t memoryBarrierCount,VkMemoryBarrier* pMemoryBarriers,uint32_t bufferMemoryBarrierCount,VkBufferMemoryBarrier* pBufferMemoryBarriers,uint32_t imageMemoryBarrierCount,VkImageMemoryBarrier* pImageMemoryBarriers);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdPipelineBarrier(VkCommandBuffer commandBuffer,void* srcStageMask,void* dstStageMask,void* dependencyFlags,uint32_t memoryBarrierCount,VkMemoryBarrier* pMemoryBarriers,uint32_t bufferMemoryBarrierCount,VkBufferMemoryBarrier* pBufferMemoryBarriers,uint32_t imageMemoryBarrierCount,VkImageMemoryBarrier* pImageMemoryBarriers);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdBeginQuery(VkCommandBuffer commandBuffer,VkQueryPool queryPool,uint32_t query,void* flags);';
        ...
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdCopyQueryPoolResults(VkCommandBuffer commandBuffer,VkQueryPool queryPool,uint32_t firstQuery,uint32_t queryCount,VkBuffer dstBuffer,uint64_t dstOffset,uint64_t stride,void* flags);';
        if($extension === 'VK_VERSION_1_0') $this->cdefs[] = 'void vkCmdPushConstants(VkCommandBuffer commandBuffer,VkPipelineLayout layout,void* stageFlags,uint32_t offset,uint32_t size,void* pValues);';
        ...
        if($extension === 'VK_EXT_debug_report') $this->cdefs[] = 'void vkDebugReportMessageEXT(VkInstance instance,void* flags,VkDebugReportObjectTypeEXT objectType,uint64_t object,size_t location,int32_t messageCode,const char* pLayerPrefix,const char* pMessage);';
        ...
        if($extension === 'VK_NV_external_memory_capabilities') $this->cdefs[] = 'VkResult vkGetPhysicalDeviceExternalImageFormatPropertiesNV(VkPhysicalDevice physicalDevice,VkFormat format,VkImageType type,VkImageTiling tiling,void* usage,void* flags,void* externalHandleType,VkExternalImageFormatPropertiesNV* pExternalImageFormatProperties);';
        if($extension === 'VK_NV_external_memory_win32') $this->cdefs[] = 'VkResult vkGetMemoryWin32HandleNV(VkDevice device,VkDeviceMemory memory,void* handleType,void* pHandle);';
        ...
        if($extension === 'VK_VERSION_1_1') $this->cdefs[] = 'void vkTrimCommandPool(VkDevice device,VkCommandPool commandPool,void* flags);';
        ...
        if($extension === 'VK_ANDROID_native_buffer') $this->cdefs[] = 'VkResult vkGetSwapchainGrallocUsageANDROID(VkDevice device,VkFormat format,void* imageUsage,int* grallocUsage);';
        if($extension === 'VK_ANDROID_native_buffer') $this->cdefs[] = 'VkResult vkGetSwapchainGrallocUsage2ANDROID(VkDevice device,VkFormat format,void* imageUsage,void* swapchainImageUsage,uint64_t* grallocConsumerUsage,uint64_t* grallocProducerUsage);';
        ...
        if($extension === 'VK_EXT_debug_utils') $this->cdefs[] = 'void vkSubmitDebugUtilsMessageEXT(VkInstance instance,VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,void* messageTypes,VkDebugUtilsMessengerCallbackDataEXT* pCallbackData);';
        ...
        if($extension === 'VK_EXT_transform_feedback') $this->cdefs[] = 'void vkCmdBeginQueryIndexedEXT(VkCommandBuffer commandBuffer,VkQueryPool queryPool,uint32_t query,void* flags,uint32_t index);';
        ...
        if($extension === 'VK_VERSION_1_3') $this->cdefs[] = 'void vkCmdSetCullMode(VkCommandBuffer commandBuffer,void* cullMode);';
        ...
        if($extension === 'VK_VERSION_1_3') $this->cdefs[] = 'void vkCmdSetStencilOp(VkCommandBuffer commandBuffer,void* faceMask,VkStencilOp failOp,VkStencilOp passOp,VkStencilOp depthFailOp,VkCompareOp compareOp);';
        ...
        if($extension === 'VK_VERSION_1_3') $this->cdefs[] = 'void vkCmdResetEvent2(VkCommandBuffer commandBuffer,VkEvent event,void* stageMask);';
        ...
        if($extension === 'VK_VERSION_1_3') $this->cdefs[] = 'void vkCmdWriteTimestamp2(VkCommandBuffer commandBuffer,void* stage,VkQueryPool queryPool,uint32_t query);';
        if($extension === 'VK_KHR_synchronization2') $this->cdefs[] = 'void vkCmdWriteBufferMarker2AMD(VkCommandBuffer commandBuffer,void* stage,VkBuffer dstBuffer,uint64_t dstOffset,uint32_t marker);';
